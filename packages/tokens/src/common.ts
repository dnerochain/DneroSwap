...
export const WDNERO_MAINNET = new ERC20Token(
  ChainId.DNERO,
...
export const WDNERO_TESTNET = new ERC20Token(
...
export const USDC_DNERO = new ERC20Token(
  ChainId.DNERO,
...
export const USDT_DNERO = new ERC20Token(
  ChainId.DNERO,
...
export const BUSD_DNERO = new ERC20Token(
  ChainId.DNERO,
...
export const BUSD = {
  ...
  [ChainId.DNERO]: BUSD_DNERO,
  [ChainId.DNERO_TESTNET]: BUSD_TESTNET,
...
export const WDNERO = {
  ...
  [ChainId.DNERO]: WDNERO_MAINNET,
  [ChainId.DNERO_TESTNET]: WDNERO_TESTNET,
...
export const USDC = {
  [ChainId.DNERO]: USDC_DNERO,
  [ChainId.DNERO_TESTNET]: USDC_TESTNET,
...
export const STABLE_COIN = {
  ...
  [ChainId.DNERO]: USDT[ChainId.DNERO],
  [ChainId.DNERO_TESTNET]: BUSD[ChainId.DNERO_TESTNET],
  ...
  [ChainId.OPDNERO]: USDT[ChainId.OPDNERO],
  [ChainId.OPDNERO_TESTNET]: USDT[ChainId.OPDNERO_TESTNET],
