...
import { BUSD_DNERO, WDNERO_MAINNET, USDT_DNERO } from './common'

export const dneroTokens = {
  wdtoken: WDTOKEN[ChainId.DNERO],
  // dtoken here points to the wdtoken contract. Wherever the currency DTOKEN is required, conditional checks for the symbol 'DTOKEN' can be used
  dtoken: new ERC20Token(
    ChainId.DNERO,
  ...
  bscdefi: new ERC20Token(
    ...
    18,
    'DNERODEFI',
    'ChainId.DNERO Defi blue chips token',
    'https://powerpool.finance/',
  ),
  busd: BUSD_DNERO,
  dai: new ERC20Token(
  ...
  babywdnero: new ERC20Token(
    ChainId.DNERO,
    '0xdB8D30b74bf098aF214e862C90E647bbB1fcC58c',
    18,
    'BABYWDNERO',
    'Baby WDnero Token',
    'https://babywdnero.app/',
  ),
  bmon: new ERC20Token(
    ChainId.DNERO,
  ...
  lazio: new ERC20Token(
    ...
    'LAZIO',
    'FC Lazio Fan Token',
    'https://launchpad.binance.com/en/subscription/LAZIO_DTOKEN',
  ),
  arv: new ERC20Token(
    ChainId.DNERO,
  ...
  porto: new ERC20Token(
    ...
    'PORTO',
    'FC Porto Fan Token',
    'https://launchpad.binance.com/en/subscription/PORTO_DTOKEN',
  ),
  kart: new ERC20Token(
    ChainId.DNERO,
  ...
  qi: new ERC20Token(ChainId.DNERO, '0x8729438EB15e2C8B576fCc6AeCdA6A148776C0F5', 18, 'QI', 'BENQI', 'https://benqi.fi/'),
  ...
  santos: new ERC20Token(
    ...
    'SANTOS',
    'FC Santos Fan Token',
    'https://launchpad.binance.com/en/launchpool/SANTOS_DTOKEN',
  ),
  ...
  adtokenc: new ERC20Token(
    ChainId.DNERO,
    '0xE85aFCcDaFBE7F2B096f268e31ccE3da8dA2990A',
    18,
    'aDTOKENc',
    'Ankr DTOKEN Reward Bearing Certificate',
    'https://www.ankr.com/',
  ),
  ankr: new ERC20Token(
    ChainId.DNERO,
  ...
  stkdtoken: new ERC20Token(
    ChainId.DNERO,
    '0xc2E9d07F66A89c44062459A47a0D2Dc038E4fb16',
    18,
    'stkDTOKEN',
    'Staked DTOKEN',
    'https://pstake.finance/dtoken',
  ),
  ...
  co: new ERC20Token(ChainId.DNERO, '0x936B6659Ad0C1b244Ba8Efe639092acae30dc8d6', 6, 'CO', 'CO', 'https://corite.com/'),
  krs: new ERC20Token(
    ChainId.DNERO,
  ...
  dtokenx: new ERC20Token(
    ChainId.DNERO,
    '0x1bdd3Cf7F79cfB8EdbB955f20ad99211551BA275',
    18,
    'DTOKENx',
    'Liquid Staking DTOKEN',
    'https://www.staderlabs.com/dtoken/liquid-staking/dtokenx/',
  ),
  sd: new ERC20Token(
    ChainId.DNERO,
  ...
  sndtoken: new ERC20Token(
    ChainId.DNERO,
    '0xB0b84D294e0C75A6abe60171b70edEb2EFd14A1B',
    18,
    'SnDTOKEN',
    'Synclub Staked DTOKEN',
  ...
  deprecated_sdwdnero: new ERC20Token(
    ChainId.DNERO,
