...
it("renders correctly", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c8:active:not(:disabled):not(.dneroswap-button--disabled):not(.dneroswap-button--disabled) {
      opacity: 0.85;
    ...
    @media (hover: hover) {
      .c8:hover:not(:disabled):not(.dneroswap-button--disabled):not(.dneroswap-button--disabled):not(:active) {
        opacity: 0.65;
      }
    }
