...
import WDneroPrice from "../../components/WDneroPrice/WDneroPrice";
  ...
  return (
    <MenuContext.Provider value={providerValue}>
            ...
            <StyledNav>
              ...
              <Flex alignItems="center" height="100%">
                <AtomBox mr="12px" display={{ xs: "none", lg: "block" }}>
                  <WDneroPrice chainId={chainId} showSkeleton={false} wdneroPriceUsd={wdneroPriceUsd} />
                </AtomBox>
                <Box mt="4px">
                  <LangSelector
      ...
      <Footer
        ...
        buyWDneroLabel={buyWDneroLabel}
        buyWDneroLink={buyWDneroLink}
