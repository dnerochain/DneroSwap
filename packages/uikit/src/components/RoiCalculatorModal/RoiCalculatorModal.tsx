    ...
    >
      <ScrollableContainer>
        ...
        <Flex flexDirection="column" mb="8px">
          ...
          {bWDneroCalculatorSlot && bWDneroCalculatorSlot(principalAsToken)}
          {autoCompoundFrequency === 0 && (
            <>
              <Text mt="24px" color="secondary" bold fontSize="12px" textTransform="uppercase">
                {t("Compounding every")}
      ...
      <RoiCalculatorFooter
        ...
        linkHref={linkHref}
        performanceFee={performanceFee}
        rewardWDneroPerSecond={rewardWDneroPerSecond}
        isLocked={isLocked}
