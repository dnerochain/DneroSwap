...
const StyledButton = styled("button").withConfig({
  ...
  @media (hover: hover) {
    &:hover:not(:disabled):not(.dneroswap-button--disabled):not(.dneroswap-button--disabled):not(:active) {
      opacity: 0.65;
    }
  }

  &:active:not(:disabled):not(.dneroswap-button--disabled):not(.dneroswap-button--disabled) {
    opacity: 0.85;
