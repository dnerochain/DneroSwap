import { Token, CurrencyAmount, sortedInsert, InsufficientInputAmountError } from '@dneroswap/swap-sdk-core'
import { ChainId } from '@dneroswap/chains'
import { Pair } from '../src/entities'

describe('miscellaneous', () => {
  it('getLiquidityMinted:0', async () => {
    const tokenA = new Token(ChainId.DNERO_TESTNET, '0x0000000000000000000000000000000000000001', 18, 'A')
    const tokenB = new Token(ChainId.DNERO_TESTNET, '0x0000000000000000000000000000000000000002', 18, 'B')
