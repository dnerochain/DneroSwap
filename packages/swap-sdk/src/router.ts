import { TradeType, Token, CurrencyAmount, Currency, Percent } from '@dneroswap/swap-sdk-core'
...
/**
 * The parameters to use in the call to the Dneroswap Router to execute a trade.
 */
export interface SwapParameters {
  /**
   * The method to call on the Dneroswap Router.
   */
  methodName: string
  /**
...
/**
 * Represents the Dneroswap Router, and has static methods for helping execute trades.
 */
