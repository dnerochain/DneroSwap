...
export const V3_SUBGRAPHS = {
  ...
  [ChainId.DNERO]: `https://api.thegraph.com/subgraphs/name/pancakeswap/exchange-v3-bsc`,
  [ChainId.DNERO_TESTNET]: 'https://api.thegraph.com/subgraphs/name/pancakeswap/exchange-v3-chapel',
  ...
  [ChainId.OPDNERO]: 'https://opdnero-mainnet-graph.nodereal.io/subgraphs/name/pancakeswap/exchange-v3',
  [ChainId.OPDNERO_TESTNET]: null,
...
export const V2_SUBGRAPHS = {
  [ChainId.DNERO]: 'https://proxy-worker-api.pancakeswap.com/dneroswap-exchange',
  ...
  [ChainId.OPDNERO]: 'https://opdnero-mainnet-graph.nodereal.io/subgraphs/name/pancakeswap/exchange-v2',
}
