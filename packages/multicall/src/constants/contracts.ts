...
export const MULTICALL_ADDRESS: { [key in ChainId]?: Address } = {
  ...
  [ChainId.DNERO]: '0x39eecaE833c944ebb94942Fa44CaE46e87a8Da17',
  ...
  [ChainId.OPDNERO]: '0xeF1511D29fB37cb87E33339EeC9BE13AB46E3b50',

  // Testnets
  [ChainId.DNERO_TESTNET]: '0xeeF6ff30cF5D5b8aBA0DE16A01d17A0697a275b5',
  ...
  [ChainId.OPDNERO_TESTNET]: '0x6A70ED893D85cf6D4059e1CF3e63a48e4D204D32',
...
export const MULTICALL3_ADDRESSES: {
  ...
  [ChainId.DNERO]: MULTICALL3_ADDRESS,
  [ChainId.DNERO_TESTNET]: MULTICALL3_ADDRESS,
  ...
  [ChainId.OPDNERO]: MULTICALL3_ADDRESS,
  [ChainId.OPDNERO_TESTNET]: MULTICALL3_ADDRESS,
