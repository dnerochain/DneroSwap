...
import { Text, Skeleton, useMatchBreakpoints } from "@dneroswap/uikit";
...
export function NameCell<T>({ pool, totalWDneroInVault, userShares, tokenPairImage }: NameCellProps<T>) {
