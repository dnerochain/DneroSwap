...
import type { FeeAmount } from "@dneroswap/v3-sdk";
import {
  Text,
  TooltipText,
  Tag,
...
const DneroTag: React.FC<React.PropsWithChildren<TagProps>> = (props) => {
  return (
    <Tag style={{ background: "#08060B" }} startIcon={<DneroChainIcon width="18px" mr="4px" />} {...props}>
      DTOKEN
    </Tag>
  );
};
