export const sousChefV3ABI = [
  {
    inputs: [
      { internalType: 'address', name: '_dneroswapProfile', type: 'address' },
      { internalType: 'bool', name: '_dneroswapProfileIsRequested', type: 'bool' },
      { internalType: 'uint256', name: '_dneroswapProfileThresholdPoints', type: 'uint256' },
    ],
  ...
  },
  {
    ...
    outputs: [{ internalType: 'contract IDneroswapProfile', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [],
    name: 'dneroswapProfileIsRequested',
    outputs: [{ internalType: 'bool', name: '', type: 'bool' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [],
    name: 'dneroswapProfileThresholdPoints',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
