...
import { livePools as opDNEROLivePools, pools as opDNEROPools } from './204'
...
import { livePools as dneroTestnetLivePools, pools as dneroTestnetPools } from './97'
...
export const LIVE_POOLS_CONFIG_BY_CHAIN = {
  ...
  [ChainId.OPDNERO]: opDNEROLivePools,
} as PoolsConfigByChain<SupportedChainId>
