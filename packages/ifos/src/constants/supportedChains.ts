...
export const PROFILE_SUPPORTED_CHAIN_IDS = [ChainId.DNERO, ChainId.DNERO_TESTNET] as const
...
export const SOURCE_CHAIN_MAP: Record<CrossChainOnlySupportedChainId, ProfileSupportedChainId> = {
  // [ChainId.POLYGON_ZKEVM]: ChainId.DNERO,
  [ChainId.GOERLI]: ChainId.DNERO_TESTNET,
}
