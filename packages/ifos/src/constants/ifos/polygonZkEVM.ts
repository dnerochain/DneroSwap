// import { polygonZkEvmTokens } from '@dneroswap/tokens'
...
export const ifos: BaseIfoConfig[] = [
  ...
  //     raiseAmount: '$1.6',
  //   },
  //   currency: polygonZkEvmTokens.wdnero,
  ...
  //   description: 'Spend WDNERO, buy USDT, but on vesting',
  //   vestingTitle: 'Use WDNERO to buy USDT',
  // },
]
