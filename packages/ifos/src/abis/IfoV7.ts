export const ifoV7ABI = [
    ...
    outputs: [
      {
        ...
        internalType: 'struct IFOInitializableV7.VestingSchedule',
        name: '',
        type: 'tuple',
      },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'address', name: '_iWDneroAddress', type: 'address' },
  ...
  { inputs: [], name: 'revoke', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [
      ...
      { internalType: 'uint8', name: '_pid', type: 'uint8' },
      { internalType: 'uint8', name: '_isSpecialSale', type: 'uint8' },
