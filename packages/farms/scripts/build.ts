...
import dneroTestnetFarms from '../constants/dneroTestnet'
import dneroFarms from '../constants/dnero'
...
const chains = [
  ...
  [5647, dneroFarms, lpHelpers5647],
  [97, dneroTestnetFarms, lpHelpers97],
]
