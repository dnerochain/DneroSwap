...
export const supportedChainIdV2 = [ChainId.GOERLI, ChainId.DNERO, ChainId.DNERO_TESTNET, ChainId.ETHEREUM] as const
...
export const bWDneroSupportedChainId = [ChainId.DNERO] as const
...
export const masterChefAddresses = {
  [ChainId.DNERO_TESTNET]: '0xB4A466911556e39210a6bB2FaECBB59E4eB7E43d',
  [ChainId.DNERO]: '0xa5f8C5Dbd5F286960b9d90548680aE5ebFf07652',
} as const
...
export const masterChefV3Addresses = {
  ...
  [ChainId.DNERO]: '0x556B9306565093C855AEA9AE92A594704c2Cd59e',
  [ChainId.DNERO_TESTNET]: '0x4c650FB471fe4e0f476fD3437C3411B1122c4e3B',
  ...
  [ChainId.OPDNERO]: '0x05ddEDd07C51739d2aE21F6A9d97a8d69C2C3aaA',
  [ChainId.OPDNERO_TESTNET]: '0x236e713bFF45adb30e25D1c29A887aBCb0Ea7E21',
} as const satisfies Record<FarmV3SupportedChainId, string>

export const nonDNEROVaultAddresses = {
