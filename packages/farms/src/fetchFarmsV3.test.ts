...
describe('fetchFarmsV3', () => {
  it('getFarmsPrices', async () => {
    const farmsData: FarmV3Data[] = [
      ...
      {
        pid: 1,
        lpSymbol: 'WDTOKEN-WDNERO LP',
        lpAddress: Pool.getAddress(dneroTokens.wdtoken, dneroTokens.wdnero, FeeAmount.MEDIUM),
        token: dneroTokens.wdtoken,
    ...
    const commonPrice = {
      [dneroTokens.usdt.address]: '1',
    }

    const wdneroPrice = '40'

    expect(getFarmsPrices(farmsData, wdneroPrice, commonPrice)).toMatchInlineSnapshot(`
      [
        {
          "feeAmount": 2500,
          "lmPool": "",
