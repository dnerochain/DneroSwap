export const bWDneroFarmBoosterV3ABI = [
  {
    inputs: [
      { internalType: 'address', name: '_wdnero', type: 'address' },
      { internalType: 'address', name: '_wdneroPool', type: 'address' },
