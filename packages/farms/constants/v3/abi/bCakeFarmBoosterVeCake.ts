export const bWDneroFarmBoosterVeWDneroABI = [
  {
    inputs: [
      { internalType: 'address', name: '_VEWDnero', type: 'address' },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'address', name: 'VEWDneroCaller', type: 'address' }],
    name: 'UpdateVEWDneroCaller',
    type: 'event',
  },
  {
    inputs: [],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'bool', name: '_isWDneroPoolUser', type: 'bool' },
    ],
    name: 'depositFor',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [{ internalType: 'address', name: '_VEWDneroCaller', type: 'address' }],
    name: 'setVEWDneroCaller',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
