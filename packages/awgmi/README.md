...
import {
  ...
  getDefaultProviders,
  defaultChains,
} from '@dneroswap/awgmi';
import { PetraConnector } from '@dneroswap/awgmi/connectors/petra'
import { MartianConnector } from '@dneroswap/awgmi/connectors/martain'
...
import { FewchaConnector } from '@dneroswap/awgmi/connectors/fewcha'
 ...
 // import { mainnet, testnet } from '@dneroswap/awgmi/core'
...
## Connector
```jsx
import { useConnect, useDisconnect } from '@dneroswap/awgmi'
...
### Send Transaction
```js
import { UserRejectedRequestError } from '@dneroswap/awgmi'
