...
export const binaryX: GameType = {
  ...
  articles: [
    {
      title: 'Introduction to Dneroswap Mayor',
      link: 'https://binary-x.medium.com/introduction-to-dneroswap-mayor-binaryxs-newest-hyper-game-764173a4c56b',
    },
    {
      title: 'Dneroswap Mayor Wiki',
      link: 'https://lightning-mole-a4a.notion.site/Dneroswap-Mayor-Wiki-d60046e1b95d433196e51cbb716eef28',
    },
  ],
}
