...
import { multicallByGasLimit } from '@dneroswap/multicall'
...
export type DneroswapMulticallConfig = {
...
/**
 * The DneroswapMulticall contract has added functionality for limiting the amount of gas
 ...
 *
 * @export
 * @class DneroswapMulticallProvider
 */
export class DneroswapMulticallProvider extends IMulticallProvider<DneroswapMulticallConfig> {
  ...
  public async callSameFunctionOnContractWithMultipleParams<TFunctionParams extends any[] | undefined, TReturn>(
    params: CallSameFunctionOnContractWithMultipleParams<TFunctionParams, DneroswapMulticallConfig>,
  ): Promise<{
    blockNumber: bigint
    results: Result<TReturn>[]
    approxGasUsedPerSuccessCall: number
  ...
  public async callMultipleFunctionsOnSameContract<TFunctionParams extends any[] | undefined, TReturn>(
    params: CallMultipleFunctionsOnSameContractParams<TFunctionParams, DneroswapMulticallConfig>,
  ): Promise<{
    blockNumber: bigint
    results: Result<TReturn>[]
    approxGasUsedPerSuccessCall: number
