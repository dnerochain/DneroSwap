import { BigintIsh, Currency, CurrencyAmount } from '@dneroswap/sdk'
...
import { DneroswapMulticallProvider } from './multicallSwapProvider'
  ...
  return function createOnChainQuoteProvider({
    ...
    const createGetRoutesWithQuotes = (isExactIn = true) => {
      ...
      return async function getRoutesWithQuote(
        ...
        const multicall2Provider = new DneroswapMulticallProvider(chainId, chainProvider, defaultGasLimitPerCall)
