import { ERC20Token, Token, WNATIVE } from '@dneroswap/sdk'
...
export const SMART_ROUTER_ADDRESSES = {
  ...
  [ChainId.DNERO]: '0x13f4EA83D0bd40E75C8222255bc855a974568Dd4',
  [ChainId.DNERO_TESTNET]: '0x9a489505a00cE272eAa5e07Dba6491314CaE3796',
  ...
  [ChainId.OPDNERO]: '0x678Aa4bF4E210cf2166753e054d5b7c31cc7fa86',
  [ChainId.OPDNERO_TESTNET]: '0xf317eD77Baed624d0EA2384AA88D91B774a9b009',
...
export const V2_ROUTER_ADDRESS: ChainMap<string> = {
  ...
  [ChainId.DNERO]: '0x10ED43C718714eb63d5aA57B78B54704E256024E',
  [ChainId.DNERO_TESTNET]: '0xD99D1c33F9fC3444f8101754aBC46c52416550D1',
  ...
  [ChainId.OPDNERO]: '0x8cFe327CEc66d1C090Dd72bd0FF11d690C33a2Eb',
  [ChainId.OPDNERO_TESTNET]: '0x62FF25CFD64E55673168c3656f4902bD7Aa5F0f4',
...
export const STABLE_SWAP_INFO_ADDRESS: ChainMap<string> = {
  [ChainId.ETHEREUM]: '',
  [ChainId.GOERLI]: '',
  [ChainId.DNERO]: '0xa680d27f63Fa5E213C502d1B3Ca1EB6a3C1b31D6',
  [ChainId.DNERO_TESTNET]: '0xaE6C14AAA753B3FCaB96149e1E10Bc4EDF39F546',
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.OPDNERO_TESTNET]: [opDneroTestnetTokens.usdc, opDneroTestnetTokens.wdtoken],
...
const czusd = new ERC20Token(ChainId.DNERO, '0xE68b79e51bf826534Ff37AA9CeE71a3842ee9c70', 18, 'CZUSD', 'CZUSD')
...
export const ADDITIONAL_BASES: {
  ...
  [ChainId.DNERO]: {
    // SNFTS-SFUND
    [dneroTokens.snfts.address]: [dneroTokens.sfund],

    [dneroTokens.ankr.address]: [dneroTokens.ankrdtoken],
    [dneroTokens.ankrdtoken.address]: [dneroTokens.ankrETH, dneroTokens.ankr],
    [dneroTokens.ankrETH.address]: [dneroTokens.ankrdtoken],

    // REVV - EDU
    [dneroTokens.revv.address]: [dneroTokens.edu],
    [dneroTokens.edu.address]: [dneroTokens.revv],
    // unshETH - USH
    [dneroTokens.unshETH.address]: [dneroTokens.ush],
    [dneroTokens.ush.address]: [dneroTokens.unshETH],

    [dneroTokens.tusd.address]: [dneroTokens.usdd],
    [dneroTokens.usdd.address]: [dneroTokens.tusd],

    // pancakeswap/dneroswap-frontend#7909
    // LSDT
 ...
 * tokens.
 * @example [AMPL.address]: [DAI, WNATIVE[ChainId.DNERO]]
 */
export const CUSTOM_BASES: {
  [chainId in ChainId]?: { [tokenAddress: string]: Token[] }
} = {
  [ChainId.DNERO]: {
    [dneroTokens.axlusdc.address]: [dneroTokens.usdt],
  },
}
