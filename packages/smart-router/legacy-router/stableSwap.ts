import { Currency, CurrencyAmount, Pair, Percent, Price, Trade, TradeType, ERC20Token } from '@dneroswap/sdk'
...
export function createStableSwapPair(
  ...
  return {
    ...
    liquidityToken: new ERC20Token(pair.token0.chainId, lpAddress, 18, 'Stable-LP', 'Dneroswap StableSwap LPs'),
