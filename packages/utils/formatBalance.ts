...
import { getLanguageCodeFromLS } from '@dneroswap/localization'
...
/**
 * Take a formatted amount, e.g. 15 DTOKEN and convert it to full decimal value, e.g. 15000000000000000
 */
