...
import { AtomBox, Button, Heading, Image, LinkExternal, Text } from '@dneroswap/uikit'
...
const IntroSteps = [
  {
    ...
    description: (
      <Trans>
        A Web3 Wallet allows you to send and receive crypto assets like bitcoin, DTOKEN, ETH, NFTs and much more.
      </Trans>
    ),
  },
  {
