...
export const GAUGES_ADDRESS = {
  [ChainId.DNERO]: GAUGES,
  [ChainId.DNERO_TESTNET]: GAUGES_TESTNET,
}

export const GAUGES_CALC_ADDRESS = {
  [ChainId.DNERO]: '0x94F8cBa8712B3E72C9BF8Ba4d6619Ac9046FE695' as const,
  [ChainId.DNERO_TESTNET]: '0x88B02E6238fa6279281eeA600CBfcAd5dd3597A5' as const,
}
