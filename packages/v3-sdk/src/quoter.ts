...
import { BigintIsh, Currency, CurrencyAmount, TradeType } from '@dneroswap/swap-sdk-core'
...
/**
 * Represents the Dneroswap V3 QuoterV1 contract with a method for returning the formatted
