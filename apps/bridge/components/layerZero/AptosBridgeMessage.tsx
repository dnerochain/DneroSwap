import { Box, Message, MessageText, WarningIcon, Flex, Link } from '@dneroswap/uikit'
    ...
    <Box width={['100%', null, '420px']} padding={['24px 24px 0 24px', '24px 24px 0 24px', '0']}>
      ...
      >
        <Flex flexDirection="column">
          ...
          <MessageText mb="5px">
            Learn more in the
            <InlineLink ml="4px" external href="https://docs.pancakeswap.finance/products/wdnero-bridging/faq">
              FAQ.
            </InlineLink>
          </MessageText>
        </Flex>
