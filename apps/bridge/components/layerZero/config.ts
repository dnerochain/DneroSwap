...
// https://unpkg.com/@layerzerolabs/x-dneroswap-widget@0.0.21/element.mjs.sha384
const SHA384 = '6KIHUDbpC4LJFNyccQRTbSygG+s+dxGst626mWRi+s+kdhal5bR8BxktVuommt67'

export const LAYER_ZERO_JS = {
  src: `https://unpkg.com/@layerzerolabs/x-dneroswap-widget@${VERSION}/element.mjs`,
  css: `https://unpkg.com/@layerzerolabs/x-dneroswap-widget@${VERSION}/element.css`,
