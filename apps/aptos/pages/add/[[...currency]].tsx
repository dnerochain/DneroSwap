...
import { AutoColumn } from '@dneroswap/uikit'
import { Liquidity as LiquidityUI } from '@dneroswap/widgets-internal'
...
import { WDNERO } from 'config/coins'
...
const AddLiquidityPage = () => {
  ...
  const defaultCurrencies = useMemo(() => [native.address, WDNERO[activeChainId].address], [native, activeChainId])
