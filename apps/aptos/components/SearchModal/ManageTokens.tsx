import { Coin, PAIR_LP_TYPE_TAG, Token } from '@dneroswap/aptos-swap-sdk'
import { APTOS_COIN, isStructTag, useAccount, useAccountBalance, useAccountBalances } from '@dneroswap/awgmi'
