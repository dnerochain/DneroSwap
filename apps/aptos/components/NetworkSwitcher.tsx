...
import { useNetwork } from '@dneroswap/awgmi'
import { useIsMounted } from '@dneroswap/hooks'
import { useTranslation } from '@dneroswap/localization'
import { Box, Text, UserMenu, UserMenuDivider, UserMenuItem } from '@dneroswap/uikit'
...
const evmChains = [
  { id: 5647, name: 'DNEROCHAIN', chainName: 'dnero' },
  ...
  { id: 204, name: 'opDNERO Mainnet', chainName: 'opDNERO' },
]
