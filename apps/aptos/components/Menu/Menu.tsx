...
import { Menu as UIMenu, footerLinks } from '@dneroswap/uikit'
import { NextLinkFromReactRouter } from '@dneroswap/widgets-internal'

import { NetworkSwitcher } from 'components/NetworkSwitcher'
import PhishingWarningBanner from 'components/PhishingWarningBanner'
import { useWDneroPrice } from 'hooks/useStablePrice'
...
export const Menu = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <UIMenu
      ...
      buyWDneroLink="https://aptos.pancakeswap.finance/swap?outputCurrency=0x159df6b7689437016108a019fd5bef736bac692b6d4a1f10c941f6fbb9a74ca6::oft::WDneroOFT"
    >
      {children}
    </UIMenu>
  )
