...
import { Currency, CurrencyAmount, Percent } from '@dneroswap/aptos-swap-sdk'
import { useAccount, useAccountBalance } from '@dneroswap/awgmi'
import { useIsMounted } from '@dneroswap/hooks'
import { useCurrencyBalance } from 'hooks/Balances'
import useStablePrice from 'hooks/useStablePrice'
import { multiplyPriceByAmount } from 'utils/prices'
import { useTranslation } from '@dneroswap/localization'
import { AtomBox, Button, ChevronDownIcon, CopyButton, Text, useModal } from '@dneroswap/uikit'
