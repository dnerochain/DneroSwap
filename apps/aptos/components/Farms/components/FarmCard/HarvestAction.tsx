...
import { Button, Flex, Heading, useToast, Balance } from '@dneroswap/uikit'
...
const HarvestAction: React.FC<React.PropsWithChildren<FarmCardActionsProps>> = ({ earnings, onReward, onDone }) => {
  ...
  const earningsBusd = rawEarningsBalance ? rawEarningsBalance.times(wdneroPrice ?? 0).toNumber() : 0
