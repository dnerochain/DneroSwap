...
import { Currency, Trade, TradeType } from '@dneroswap/aptos-swap-sdk'
...
const TransactionConfirmSwapContent = ({
  ...
  const isEnoughInputBalance = useMemo(() => {
    ...
    const isInputBalanceDTOKEN = isInputBalanceExist && currencyBalances[Field.INPUT].currency.isNative
    const inputCurrencyAmount = isInputBalanceExist
      ? isInputBalanceDTOKEN
