...
import { Box, Flex, Text, useMatchBreakpoints, HelpIcon, useTooltip } from '@dneroswap/uikit'

import { FarmWidget, Pool } from '@dneroswap/widgets-internal'
...
import WDneroTableActions from './WDneroTableActions'
...
const ActionPanel: React.FC<React.PropsWithChildren<ActionPanelProps>> = ({ account, pool, expanded }) => {
  ...
  const Actions = isVaultPool() ? WDneroTableActions : TableActions
