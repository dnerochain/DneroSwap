import { AptosCoin, ChainId, Coin } from '@dneroswap/aptos-swap-sdk'
...
export const WDNERO = {
  [ChainId.MAINNET]: new Coin(
    ChainId.MAINNET,
    '0x159df6b7689437016108a019fd5bef736bac692b6d4a1f10c941f6fbb9a74ca6::oft::WDneroOFT',
    8,
    'WDNERO',
    'DneroSwap Token',
  ),
  [ChainId.TESTNET]: new Coin(
    ChainId.TESTNET,
    '0xe0e5ad285cbcdb873b2ee15bb6bcac73d9d763bcb58395e894255eeecf3992cf::dneroswap::WDnero',
    8,
    'WDNERO',
    'DneroSwap Token',
  ),
...
export const CE_DTOKEN_MAINNET = new Coin(
  ChainId.MAINNET,
  '0x8d87a65ba30e09357fa2edea2c80dbac296e5dec2b18287113500b902942929d::celer_coin_manager::DTokenCoin',
  8,
  'ceDTOKEN',
  'Celer - Binance Coin',
)
