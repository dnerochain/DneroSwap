...
export const ifos: Ifo[] = [
  {
    id: 'move',
    address: `${IFO_POOL_STORE_TAG}<${mainnetTokens.wdnero.address}, ${mainnetTokens.move.address}, ${getIFOUID(1)}>`,
    isActive: false,
    name: 'MOVE',
    poolUnlimited: {
    ...
    campaignId: '1',
    currency: mainnetTokens.wdnero,
    token: mainnetTokens.move,
    releaseTime: 1675944000,
    articleUrl: 'https://medium.com/pancakeswap/bluemove-move-ifo-to-be-hosted-on-aptos-dneroswap-25adee83d1ee',
