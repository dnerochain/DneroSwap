...
export type MasterchefUpdateWDneroRateArgs = [bigint | string, bigint | string, boolean]

export const masterchefUpdateWDneroRate = (
  args: MasterchefUpdateWDneroRateArgs,
): Types.TransactionPayload_EntryFunctionPayload => {
  return {
    type: 'entry_function_payload',
    type_arguments: [],
    arguments: args,
    function: `${ADDRESS}::${MASTERCHEF_MODULE_NAME}::update_wdnero_rate`,
  }
}
