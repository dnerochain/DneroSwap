import { ChainId, ONE_HUNDRED_PERCENT, Percent, Token, Coin } from '@dneroswap/aptos-swap-sdk'
import { APT, CE_USDC, L0_USDC, WH_USDC, WDNERO, CE_DTOKEN_MAINNET } from 'config/coins'
...
export const SUGGESTED_BASES: ChainTokenList = {
  [ChainId.MAINNET]: [L0_USDC[ChainId.MAINNET], WDNERO[ChainId.MAINNET], CE_DTOKEN_MAINNET],
  [ChainId.TESTNET]: [L0_USDC[ChainId.TESTNET], WDNERO[ChainId.TESTNET], CE_DTOKEN_MAINNET],
}
...
export const BASES_TO_CHECK_TRADES_AGAINST = {
  [ChainId.TESTNET]: [
    ...
    new Coin(
      ChainId.TESTNET,
      '0x8c805723ebc0a7fc5b7d3e7b75d567918e806b3461cb9fa21941a9edc0220bf::devnet_coins::DevnetDTOKEN',
      8,
      'DTOKEN',
    ),
    new Coin(
