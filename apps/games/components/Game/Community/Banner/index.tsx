...
import { GameType } from '@dneroswap/games'
import { Box, Flex, Text, ChevronLeftIcon, ChevronRightIcon, useMatchBreakpoints } from '@dneroswap/uikit'
import 'swiper/css'
      ...
      <Flex position="relative" zIndex="1" margin="auto" flexDirection="column" alignItems="center">
        ...
        >
          <Text bold color="secondary" lineHeight="110%" fontSize={['40px']} mb={['8px', '8px', '8px', '8px', '24px']}>
            {isDesktop ? t('DneroSwap Gaming Community') : t('Gaming Community')}
          </Text>
