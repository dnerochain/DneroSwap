...
import { ArrowForwardIcon, Box, Flex, LinkExternal, Text, useMatchBreakpoints } from '@dneroswap/uikit'
  ...
  return (
    <StyledContainer>
      <Box margin="auto" width={['100%', '100%', '100%', '100%', '100%', '100%', '1019px']}>
        ...
        >
          {isDesktop ? t('DneroSwap Gaming Marketplace') : t('Gaming Marketplace')}
        </Text>
        <Text bold lineHeight="110%" fontSize={['16px', '16px', '16px', '16px', '24px']}>
          {t('Play, Build and Connect on DneroSwap')}
        </Text>
        <Flex mt="16px">
