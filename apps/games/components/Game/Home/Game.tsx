...
import { GameType, PostersLayout, PostersItemData } from '@dneroswap/games'
import { Flex, Box, Text, Button, CardHeader, Link, Card, TelegramIcon, useMatchBreakpoints } from '@dneroswap/uikit'
...
export const Game: React.FC<React.PropsWithChildren<GameProps>> = ({ isLatest, game }) => {
  ...
  return (
    <StyledGameContainer isHorizontal={isHorizontal}>
      {isLatest && isDesktop && game.id === 'dneroswap-protectors' && (
