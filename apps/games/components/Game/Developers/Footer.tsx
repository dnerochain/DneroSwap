...
import { Box, Button, Flex, Link, Text, useMatchBreakpoints } from '@dneroswap/uikit'
import SunburstSvg from 'components/Game/Developers/SunburstSvg'
import ctaDneroswapBig from 'components/Game/Developers/images/cta-dneroswap-big.png'
import ctaDneroswap from 'components/Game/Developers/images/cta-dnero.png'
  ...
  return (
    <StyledContainer>
      <BgWrapper>
        ...
        <ImageWrapper>
          <Image className="dneroswap" src={ctaDneroswap} alt="dneroswap" />
          <Image className="rock" src={ctaRock} alt="rock" />
          <Image className="big-dneroswap" src={ctaDneroswapBig} alt="big-dneroswap" />
      ...
      <Wrapper>
        <Text mb="24px" fontWeight={600} color="#F4EEFF" textAlign="center" fontSize={isMobile ? 32 : 40}>
          {t('Build Games with DneroSwap Now')}
        </Text>
