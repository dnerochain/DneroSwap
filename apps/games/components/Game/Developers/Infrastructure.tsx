...
import { Flex, Text, Heading, Card, PageSection, Box } from '@dneroswap/uikit'
...
const GameBenefitsList = [
  ...
  },
  {
    ...
    desc: <Trans>Integrate WDNERO tokens and NFTs to enrich the gaming experience</Trans>,
  ...
  },
  {
    ...
    desc: <Trans>DneroSwap operates on 9 popular blockchains, welcoming developers from diverse ecosystems</Trans>,
      ...
      >
        <Flex pt={['0', '0', '0', '0', '24px']} alignItems="center" flexDirection="column" justifyContent="center">
          ...
          <Heading maxWidth={['745px']} textAlign="center" scale="xl" mb="32px">
            {t('Bring Your Game to Life on DneroSwap')}
          </Heading>
