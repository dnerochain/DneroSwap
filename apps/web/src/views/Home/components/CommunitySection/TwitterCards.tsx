...
export const useTweetsData = () => {
  return useMemo(() => {
    return [
      {
        tweet: `🥞Your WDNERO, Your Voice
🐰Introducing Gauges Voting and veWDNERO
🏦More governance power 
🪒Control WDNERO emissions 
🌊Deeper liquidity 
🪙Vote Incentives`,
        link: 'https://x.com/DneroSwap/status/1727311273023742115?s=20',
        date: 'Nov 22',
        like: '1.2k',
        impression: '377k',
      },
    ...
    <Wrapper>
      ...
      <Flex alignItems="center">
        <Text mt="10px" fontSize={14} bold>
          DneroSwap🥞Ev3ryone&#39;s Favourite D3X
        </Text>
