...
import { Button, Text, useMatchBreakpoints, Box, OpenNewIcon } from '@dneroswap/uikit'
import { ASSET_CDN } from 'config/constants/endpoints'
import Image from 'next/legacy/image'
import { styled } from 'styled-components'
import * as S from './Styled'

const { ETHBunny, ETHXDneroSwap } = {
  ETHBunny: `${ASSET_CDN}/web/banners/ETHBunny.png`,
  ETHXDneroSwap: `${ASSET_CDN}/web/banners/ethXpancakeswap.png`,
}
  ...
  return (
    ...
    >
      <S.Inner>
        <S.LeftWrapper>
          <Box marginTop="3px">
            <Image src={ETHXDneroSwap} alt="eth pancake" width={119} height={18} unoptimized />
          </Box>
