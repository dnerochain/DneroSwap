...
import { ArrowForwardIcon, Button, Link, Text, useMatchBreakpoints, useModal, Flex, Box } from '@dneroswap/uikit'
      ...
      <S.Inner>
        <S.LeftWrapper position="relative" style={{ zIndex: 2 }}>
          ...
          <Flex style={{ gap: isMobile ? 4 : 16 }}>
            ...
            <Link
              href="https://blog.pancakeswap.finance/articles/dneroswap-swap-s-perpetual-trading-powered-by-apollo-x-v2-now-fully-on-chain-with-low-fees-and-more-transparency"
              external
