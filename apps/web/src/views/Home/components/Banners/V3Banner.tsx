...
import { Button, Text, useMatchBreakpoints, OpenNewIcon } from '@dneroswap/uikit'
...
const V3Banner = () => {
  ...
  return (
    ...
    >
      <S.Inner>
        <S.LeftWrapper>
          <Title>{t('DneroSwap V3')}</Title>
          <StyledSubheading data-text={t('Claim $135K WDNERO Airdrop & Exclusive NFT')}>
            {t('Claim $135K WDNERO Airdrop & Exclusive NFT')}
          </StyledSubheading>
          <NextLinkFromReactRouter
            target="_blank"
            to="https://blog.pancakeswap.finance/articles/participate-in-dneroswap-swap-v3-launch-claim-135-k-wdnero-airdrop-and-receive-an-exclusive-nft-for-early-supporters"
