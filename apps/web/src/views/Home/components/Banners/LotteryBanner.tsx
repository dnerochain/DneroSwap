import { ArrowForwardIcon, Button, Heading, Skeleton, Text, useMatchBreakpoints } from '@dneroswap/uikit'
...
const LotteryPrice: React.FC<React.PropsWithChildren> = () => {
  ...
  const prizeInBusd = new BigNumber(data?.amountCollectedInWDnero || Number.NaN).times(wdneroPriceBusd)
