import { Button, Flex, Text, useMatchBreakpoints, OpenNewIcon } from '@dneroswap/uikit'
...
export const PolygonZkEvmBanner = () => {
  ...
  const title = isDesktop ? t('DneroSwap Now Live on Polygon zkEVM!') : t('Polygon zkEVM is LIVE!')
        ...
        <S.LeftWrapper>
          ...
          <Flex>
            <NextLinkFromReactRouter
              target="_blank"
              to="https://blog.pancakeswap.finance/articles/dneroswap-swap-expands-to-polygon-zk-evm-a-new-era-of-multichain-de-fi-begins"
            >
