    ...
    >
      <S.Inner>
        <S.LeftWrapper position="relative" style={{ zIndex: 2 }}>
          ...
          {isDesktop ? (
            <StyledSubheading>
              {t('Get your custom branded subdomains .dneroswap.crypto for just $9.99')}
            </StyledSubheading>
          ) : (
            <MobileSubheading>{t('Subdomains .dneroswap.crypto for just $9.99')}</MobileSubheading>
          )}
          ...
          <Flex alignItems="center" style={{ gap: isMobile ? 4 : 16 }}>
            ...
            <Devider />
            <Link
              href="https://blog.pancakeswap.finance/articles/unlocking-the-power-of-web3-domains-dneroswap-swap-integrates-with-unstoppable-domains"
              external
        ...
        <RightWrapper>
          ...
          {!isMobile && (
            <>
              <Image src={unsLogo} alt="dneroswapProtectorBunny" width={162} height={51} unoptimized />
