...
import { Button, Flex, LogoIcon, OpenNewIcon, Text, useMatchBreakpoints } from '@dneroswap/uikit'
...
const { v3LaunchBg, v3LaunchBgMobile, v3LaunchBunny, v3LaunchBunnyMobile, v3LaunchDToken, v3LaunchEth, v3LaunchFlag } = {
...
const RightWrapper = styled.div`
  ...
  > span:nth-child(3) {
    ...
    z-index: 3;
    right: 0px;
    animation: ${flyingAnimDToken} 12.5s ease-in-out infinite;
  }
  > span:nth-child(4) {
    // v3LaunchEth
    ...
    >
      <S.Inner>
        <S.LeftWrapper style={{ zIndex: 2 }}>
          <TextBox>
            ...
            <TitleWrapper alignItems="center" style={{ gap: 5 }}>
              <LogoIcon /> <Title>{t('DneroSwap v3 is live!')}</Title>
            </TitleWrapper>
          </TextBox>
          <NextLinkFromReactRouter
            target="_blank"
            to="https://blog.pancakeswap.finance/articles/introducing-dneroswapswap-swap-v3-a-more-efficient-and-user-friendly-dex-on-bnb-chain-and-ethereum"
        ...
        <RightWrapper>
          ...
          {!isMobile && <Image src={v3LaunchDToken} alt="v3LaunchDToken" width={204} height={123} unoptimized />}
