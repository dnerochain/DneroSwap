...
import { Box, Flex, Link, OpenNewIcon, Text, useMatchBreakpoints, Button } from '@dneroswap/uikit'
    ...
    >
      <S.Inner>
        <S.LeftWrapper position="relative" style={{ zIndex: 3, justifyContent: isMobile ? 'flex-start' : 'center' }}>
          ...
          <Header data-text={isMobile ? t('Gaming Marketplace') : t('DneroSwap Gaming Marketplace')}>
            {isMobile ? t('Gaming Marketplace') : t('DneroSwap Gaming Marketplace')}
          </Header>
          <Box>
            {isDesktop ? (
              <Flex mt="8px">
