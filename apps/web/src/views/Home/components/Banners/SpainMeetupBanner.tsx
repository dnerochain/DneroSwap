...
import { Flex, FlexGap, useMatchBreakpoints, Link, Text } from '@dneroswap/uikit'
import { useTranslation } from '@dneroswap/localization'
import { useCountdown } from '@dneroswap/hooks'
        ...
        <ContentWrapper gap="1rem" width="100%">
          <FlexGap gap={isMobile ? '1rem' : '0.5rem'} flexDirection="column">
            <Image
              ...
              unoptimized
            />
            <StyledHeading data-text={t('DneroSwap Meetup')}>{t('DneroSwap Meetup')}</StyledHeading>
          ...
          <Flex height="100%">
            ...
            <TicketBtnContainer>
              <Link
                href="https://www.eventbrite.com/e/entradas-dneroswap-meetup-in-spain-764126180977?aff=oddtdtcreator"
                external
