import { Flex, Text, Box, ChevronRightIcon, useMatchBreakpoints, useModal } from '@dneroswap/uikit'
...
import gameDneroswapProtectors from '../../images/game-dneroswap-protectors.png'
...
import gameDneroswapProtectorsPurple from '../../images/game-dneroswap-protectors-purple.png'
...
const useEarnBlockData = () => {
  ...
  return useMemo(() => {
    return [
      {
        title: t('Farm'),
        description: t('Stake LP tokens, harvest WDNERO'),
      ...
      {
        title: t('Pools'),
        description: t('Stake WDNERO, earn various rewards'),
        ctaTitle: t('Stake Now'),
        image: earnPools,
...
const useNftGameBlockData = () => {
  ...
  return useMemo(() => {
    return [
      ...
      {
        title: t('Dneroswap Protectors'),
        description: t('Immersive PvP & PvE tower-defense GameFi'),
        ctaTitle: t('Play Now'),
        image: gameDneroswapProtectors,
        defaultImage: gameDneroswapProtectorsPurple,
        path: 'https://protectors.pancakeswap.finance/',
      },
      {
        title: t('Lottery'),
        description: t('Enter for a chance to win WDNERO prize pools'),
        ctaTitle: t('Try Now'),
        image: gameLottery,
      ...
      {
        title: t('Pottery'),
        description: t('Stake WDNERO, acquire pottery tickets, win prizes'),
        ctaTitle: t('Try Now'),
        image: gamePottery,
      ...
      },
      {
        ...
        description: t('Trade unique NFTs on DneroChain'),
        ctaTitle: t('Trade Now'),
