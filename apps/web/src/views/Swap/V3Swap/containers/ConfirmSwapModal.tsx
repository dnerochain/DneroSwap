...
import { Currency, CurrencyAmount, Token, TradeType } from '@dneroswap/sdk'
import { ChainId } from '@dneroswap/chains'

import { Box, DneroScanIcon, Flex, InjectedModalProps, Link } from '@dneroswap/uikit'
import {
  ApproveModalContent,
  SwapPendingModalContent,
  SwapTransactionReceiptModalContent,
} from '@dneroswap/widgets-internal'
        ...
        <SwapTransactionReceiptModalContent>
          {chainId && (
            <Link external small href={getBlockExploreLink(txHash, 'transaction', chainId)}>
              ...
              {chainId === ChainId.DNERO && <DneroScanIcon color="primary" ml="4px" />}
            </Link>
          )}
          <AddToWalletButton
            mt="39px"
