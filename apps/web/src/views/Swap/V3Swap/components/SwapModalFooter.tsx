...
import { SmartRouterTrade, SmartRouter } from '@dneroswap/smart-router/evm'
import { Currency, CurrencyAmount, Percent, TradeType } from '@dneroswap/sdk'
import { BackForwardIcon, Button, QuestionHelper, Text, Link, AutoColumn, Dots, Flex } from '@dneroswap/uikit'
              ...
              text={
                isMM ? (
                  <>
                    ...
                    <Text>- {t('%amount% towards WDNERO buyback and burn', { amount: buyBackFeePercent })}</Text>
                    <Text mt="12px">
                    ...
                    <Text mt="10px">
                      ...
                      :{' '}
                      {t(
                        'DneroSwap does not charge any fees for trades. However, the market makers charge an implied fee of 0.05% - 0.25% (non-stablecoin) / 0.01% (stablecoin) factored into the quotes provided by them.',
                      )}
                    </Text>
                  </>
                ) : (
