...
import { ButtonMenu, ButtonMenuItem, Checkbox, Flex, Text, useMatchBreakpoints } from '@dneroswap/uikit'
...
const LIQUIDITY_FILTER = { [ChainId.DNERO]: 100000, [ChainId.ETHEREUM]: 50000 }
      ...
      <Wrapper>
        <MenuWrapper>
          <ButtonMenu activeIndex={index} onItemClick={setIndex} fullWidth scale="sm" variant="subtle">
            <ButtonMenuItem>{chainId === ChainId.DNERO ? t('Price Change') : t('Liquidity')}</ButtonMenuItem>
        ...
        {index === 0 ? (
          <TokenTable
            ...
            type={chainId === ChainId.DNERO ? 'priceChange' : 'liquidity'}
            defaultSortField={chainId === ChainId.DNERO ? 'priceUSDChange' : 'liquidityUSD'}
