...
import { OptionProps } from '@dneroswap/uikit'
import {
  EventInformation,
  DneroswapNotificationBuilders,
  ResponseEvents,
  SubsctiptionType,
  pushNotification,
} from './types'
...
export const DneroswapNotifications: {
  [notificationBuilder in keyof DneroswapNotificationBuilders]: <T>(args: T[]) => pushNotification
} = {
