import { Skeleton, Heading, Text } from '@dneroswap/uikit'
...
import WDnerorsShare from '../../../pngs/mobox-wdnerors-share.png'
      ...
      <ScoreCard
        ...
        extraUserRankBox={
          <UserRankBox
            ...
            footer={t('Based on your MBOX/DTOKEN and MBOX/BUSD trading')}
        ...
        cakersShareImage={WDnerorsShare}
