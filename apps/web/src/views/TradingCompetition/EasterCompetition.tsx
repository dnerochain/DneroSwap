...
import EasterWDnerorBunny from './pngs/easter-wdnerors.png'
...
const EasterCompetition = () => {
  ...
  const { hasUserClaimed, userWDneroRewards, userPointReward, canClaimNFT } = userTradingInformation

  const userCanClaimPrizes =
    currentPhase.state === CLAIM &&
    !hasUserClaimed &&
    (userWDneroRewards !== '0' || userPointReward !== '0' || canClaimNFT)
  ...
  useEffect(() => {
    ...
    const fetchUserContract = async () => {
      ...
      const userObject = {
        ...
        userWDneroRewards: user[3].toString(),
