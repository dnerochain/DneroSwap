...
const TopTradersCard: React.FC<React.PropsWithChildren<TeamRanksProps & { subgraphName?: string }>> = ({
  ...
  const tabs = [t('Total'), 'Storm', 'Flippers', 'WDnerors']
          ...
          <Flex justifyContent="space-between">
            ...
            {subgraphName && (
              <SubgraphHealthIndicator
                ...
                customDescriptions={{
                  delayed: t(
                    'Subgraph is currently experiencing delays due to DNERO issues. Rank and volume data may be inaccurate until subgraph is restored.',
                  ),
                  slow: t(
                    'Subgraph is currently experiencing delays due to DNERO issues. Rank and volume data may be inaccurate until subgraph is restored.',
                  ),
