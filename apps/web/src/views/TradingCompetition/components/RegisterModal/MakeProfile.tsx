import { Button, Heading, Text } from '@dneroswap/uikit'
  ...
  return (
    <>
      ...
      <Text color="textSubtle">
        {t('It looks like you’ve disabled your account by removing your Dneroswap Collectible (NFT) profile picture.')}
      </Text>
