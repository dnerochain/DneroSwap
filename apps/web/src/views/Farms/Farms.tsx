import { DeserializedFarm, FarmWithStakedValue, filterFarmsByQuery } from '@dneroswap/farms'
...
const Farms: React.FC<React.PropsWithChildren> = ({ children }) => {
  ...
  const { data: farmsLP, userDataLoaded, poolLength, regularWDneroPerBlock } = useFarms()
  ...
  const farmsList = useCallback(
    ...
    [query, isActive, chainId, wdneroPrice, regularWDneroPerBlock],
  )
  ...
  return (
    <FarmsContext.Provider value={providerValue}>
      ...
      <Page>
        ...
        {isInactive && chainId === ChainId.DNERO && (
        ...
        {viewMode === ViewMode.TABLE ? (
          <Table farms={chosenFarmsMemoized as V2Farm[]} wdneroPrice={wdneroPrice} userDataReady={userDataReady} />
        ) : (
