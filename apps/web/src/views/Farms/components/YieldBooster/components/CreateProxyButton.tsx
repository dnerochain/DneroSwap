...
import { AutoRenewIcon, Button, ButtonProps, useToast } from '@dneroswap/uikit'
import { ToastDescriptionWithTx } from 'components/Toast'
import useCatchTxError from 'hooks/useCatchTxError'
import { useBWDneroFarmBoosterProxyFactoryContract } from 'hooks/useContract'
...
const CreateProxyButton: React.FC<React.PropsWithChildren<CreateProxyButtonProps>> = ({ onDone, ...props }) => {
  ...
  const farmBoosterProxyFactoryContract = useBWDneroFarmBoosterProxyFactoryContract()
