...
import { Card, ExpandableSectionButton, Flex, Skeleton, Text, useModalV2 } from '@dneroswap/uikit'
...
const FarmCard: React.FC<React.PropsWithChildren<FarmCardProps>> = ({
  ...
  const { totalMultipliers, getFarmWDneroPerSecond } = useFarmV2Multiplier()
