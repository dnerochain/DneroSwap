...
import { Text, Button, useMatchBreakpoints } from '@dneroswap/uikit'
...
export const TEXT = {
  v2: {
    ...
    steps: [
      {
        title: <Trans>Unstaking LP Tokens and WDNERO</Trans>,
        subTitle: <Trans>All the earned WDNERO will be harvested to your wallet upon unstake.</Trans>,
  ...
  v3: {
    title: <Trans>DneroSwap v3 Migration</Trans>,
    steps: [
      {
      ...
      },
      {
        ...
        subTitle: <Trans>Start earning WDNERO by staking your liquidity positions to V3 Farms!</Trans>,
