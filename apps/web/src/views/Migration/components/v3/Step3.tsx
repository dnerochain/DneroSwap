import { useTheme } from '@dneroswap/hooks'
import { AtomBox, AutoColumn, AutoRow, Heading, LinkExternal, Text } from '@dneroswap/uikit'
import { Chart } from '@dneroswap/widgets-internal'
...
const MOCK_TOKENS = {
  [ChainId.DNERO]: [dneroTokens.wdnero, dneroTokens.wdtoken],
...
export function Step3() {
  ...
  const [token0, token1] = chainId && MOCK_TOKENS[chainId] ? MOCK_TOKENS[chainId] : MOCK_TOKENS[ChainId.DNERO]
  ...
  return (
    <AtomBox textAlign="center">
      <Heading scale="lg" pb="16px">
        {t('Quick Start')} - {t('DneroSwap V3')}
      </Heading>
      <Text pb="48px">
        {t(
          'In DneroSwap Exchange V3, liquidity providers are able to customize the trading fee tier and concentrate their liquidity to a specific price range to maximize their capital efficiency.',
        )}
      </Text>
