...
export const processLotteryResponse = (
  ...
  const {
    priceTicketInWDnero: priceTicketInWDneroAsString,
    discountDivisor: discountDivisorAsString,
    amountCollectedInWDnero: amountCollectedInWDneroAsString,
  } = lotteryData

  const discountDivisor = new BigNumber(discountDivisorAsString)
  const priceTicketInWDnero = new BigNumber(priceTicketInWDneroAsString)
  const amountCollectedInWDnero = new BigNumber(amountCollectedInWDneroAsString)
  ...
  return {
    ...
    wdneroPerBracket: lotteryData.wdneroPerBracket,
