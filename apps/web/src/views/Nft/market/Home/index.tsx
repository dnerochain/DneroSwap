...
import { Box, Button, Flex, Heading, LinkExternal, PageHeader, PageSection } from '@dneroswap/uikit'
...
const Home = () => {
  ...
  const hotCollections = orderBy(
    collections,
    (collection) => (collection.totalVolumeDTOKEN ? parseFloat(collection.totalVolumeDTOKEN) : 0),
    'desc',
  )
        ...
        <StyledHeaderInner>
          <div>
            ...
            <Heading scale="lg" color="text">
              {t('Buy and Sell NFTs on DNEROCHAIN')}
            </Heading>
            {account && (
