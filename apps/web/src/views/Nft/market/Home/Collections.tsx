import { Button, ChevronRightIcon, Flex, Grid, Heading, Text } from '@dneroswap/uikit'
          ...
          return (
            ...
            >
              <Flex alignItems="center">
                ...
                <DTOKENAmountLabel amount={collection.totalVolumeDTOKEN ? parseFloat(collection.totalVolumeDTOKEN) : 0} />
              </Flex>
            </CollectionCard>
          )
        })}
