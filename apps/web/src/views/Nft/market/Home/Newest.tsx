...
import { Heading, Flex, Button, Grid, ChevronRightIcon } from '@dneroswap/uikit'
  ...
  return (
    <>
      ...
      {nfts ? (
        ...
        >
          {nfts.map((nft) => {
            const isPBCollection = safeGetAddress(nft.collectionAddress) === safeGetAddress(dneroswapBunniesAddress)
