...
export const useDneroswapBunnyOnSaleNfts = (
  bunnyId: string,
  nftMetadata: ApiResponseCollectionTokens,
  itemsPerPage: number,
) => {
  ...
  const {
    ...
    (pageIndex, previousPageData) => {
      ...
      return [bunnyId, direction, pageIndex, 'dneroswapBunnyOnSaleNfts'] as const
    },
    async ([id, sortDirection, page]) => {
      ...
      const updatedMarketData = await getNftsUpdatedMarketData(dneroswapBunniesAddress, nftsMarketTokenIds)
