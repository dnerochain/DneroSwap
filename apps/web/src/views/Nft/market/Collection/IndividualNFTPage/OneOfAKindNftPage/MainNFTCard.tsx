import { BinanceIcon, Box, Button, Card, CardBody, Flex, Skeleton, Text, useModal } from '@dneroswap/uikit'
...
const MainNFTCard: React.FC<React.PropsWithChildren<MainNFTCardProps>> = ({
  ...
  const priceInUsd = dtokenBusdPrice.multipliedBy(currentAskPriceAsNumber).toNumber()
