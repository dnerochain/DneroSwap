...
import { useDneroswapBunnyOnSaleNfts } from '../../../../hooks/useDneroswapBunnyOnSaleNfts'
...
const ForSaleTableCard: React.FC<React.PropsWithChildren<ForSaleTableCardProps>> = ({
  ...
  const {
    ...
    isLastPage,
    isValidating,
  } = useDneroswapBunnyOnSaleNfts(bunnyId, nftMetadata, itemsPerPage * 10)
  ...
  return (
    <StyledCard hasManyPages>
      ...
      >
        ...
        <UpdateIndicator isFetchingDneroswapBunnies={isValidating} />
      </Grid>
