...
import { Skeleton, Table, Td, Th, Flex, ArrowUpIcon, ArrowDownIcon } from '@dneroswap/uikit'
...
import { DTOKENAmountLabel } from '../../components/CollectibleCard/styles'
...
interface DneroswapBunniesTraitsProps {
...
const LowestPriceCell: React.FC<React.PropsWithChildren<{ bunnyId: string }>> = ({ bunnyId }) => {
  ...
  return <DTOKENAmountLabel justifyContent="flex-end" amount={lowestPrice} width="100px" />
}

const DneroswapBunniesTraits: React.FC<React.PropsWithChildren<DneroswapBunniesTraitsProps>> = ({ collectionAddress }) => {
...
export default DneroswapBunniesTraits
