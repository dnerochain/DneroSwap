import { Flex, Text, Button, ArrowUpIcon, ScanLink } from '@dneroswap/uikit'
  ...
  return (
    <>
      <Flex p="16px" flexDirection="column" alignItems="center" justifyContent="space-between" height="150px">
        ...
        <ScanLink href={getBlockExploreLink(txHash, 'transaction', chainId)}>{t('View on DneroScan')}</ScanLink>
      </Flex>
      <Divider />
