import { Flex, Text, Button, Spinner } from '@dneroswap/uikit'
...
// Buy Flow:
// Shown if user wants to pay with WDTOKEN and contract isn't approved yet
// Sell Flow:
        ...
        <Flex flexDirection="column">
          ...
          {!isApproved && (
            <Text mt="8px" maxWidth="275px" small color="textSubtle">
              {variant === 'buy'
                ? t('Please enable WDTOKEN spending in your wallet')
