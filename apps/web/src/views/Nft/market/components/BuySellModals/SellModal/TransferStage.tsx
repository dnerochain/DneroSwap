import { Flex, Grid, Text, Button, Input, BinanceIcon, ErrorIcon } from '@dneroswap/uikit'
...
const TransferStage: React.FC<React.PropsWithChildren<TransferStageProps>> = ({
  ...
  const getErrorText = () => {
    if (isInvalidTransferAddress) {
      return t('That’s not a DNEROCHAIN wallet address.')
    }
    ...
    <>
      ...
      <GreyedOutContainer>
        ...
        <Input
          ...
          placeholder={t('Paste DNERO address')}
