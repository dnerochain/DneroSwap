import { Flex, Grid, Text, Button, BinanceIcon, LinkExternal, useModal, ScanLink } from '@dneroswap/uikit'
import { useTranslation } from '@dneroswap/localization'
import { nftsBaseUrl, dneroswapBunniesAddress } from 'views/Nft/market/constants'
import { NftToken } from 'state/nftMarket/types'
import { getDneroScanLinkForNft, safeGetAddress } from 'utils'
...
const SellStage: React.FC<React.PropsWithChildren<SellStageProps>> = ({
  ...
  const itemPageUrlId =
    safeGetAddress(nftToSell.collectionAddress) === safeGetAddress(dneroswapBunniesAddress)
    ...
    <>
      ...
      <Flex justifyContent="space-between" px="16px" mt="8px">
        ...
        <Flex justifyContent="space-between" flex="3">
          ...
          <HorizontalDivider />
          <ScanLink p="0px" height="16px" href={getDneroScanLinkForNft(nftToSell.collectionAddress, nftToSell.tokenId)}>
            DneroScan
          </ScanLink>
        </Flex>
      </Flex>
