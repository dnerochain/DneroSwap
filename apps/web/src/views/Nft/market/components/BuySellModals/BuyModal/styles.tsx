...
import { Modal, Grid, Flex, Text, BinanceIcon, Skeleton } from '@dneroswap/uikit'
...
export const DTokenAmountCell: React.FC<React.PropsWithChildren<DTokenAmountCellProps>> = ({
  dtokenAmount,
  isLoading,
  isInsufficient,
}) => {
  ...
  return (
    <Flex justifySelf="flex-end" flexDirection="column">
      <Flex justifyContent="flex-end">
        ...
        <Text bold color={isInsufficient ? 'failure' : 'text'}>{`${dtokenAmount.toLocaleString(undefined, {
