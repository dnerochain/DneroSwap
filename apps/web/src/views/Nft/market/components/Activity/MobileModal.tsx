import { InjectedModalProps, Modal, Flex, Text, Button, BinanceIcon, Box, DneroScanIcon } from '@dneroswap/uikit'
...
const MobileModal: React.FC<React.PropsWithChildren<MobileModalProps>> = ({
  ...
  const priceInUsd = dtokenBusdPrice.multipliedBy(priceAsFloat)
