import { Flex, BinanceIcon, Text, Skeleton } from '@dneroswap/uikit'
import BigNumber from 'bignumber.js'

const ActivityPrice = ({ dtokenBusdPrice, price }: { dtokenBusdPrice: BigNumber; price: number }) => {
  const priceInUsd = dtokenBusdPrice.multipliedBy(price).toNumber()
