      ...
      <Flex flexDirection="column" maxWidth="420px">
        ...
        <Flex justifyContent="space-between" px="16px" mb="16px">
          ...
          <Flex justifyContent="space-between" flex="3">
            ...
            <HorizontalDivider />
            <ScanLink p="0px" height="16px" href={getDneroScanLinkForNft(nft.collectionAddress, nft.tokenId)}>
              DneroScan
            </ScanLink>
          </Flex>
        </Flex>
        <TextWrapper p="24px 16px" flexDirection="column">
          <Text mb="16px">{t("You're using this NFT as your Dneroswap Profile picture")}</Text>
