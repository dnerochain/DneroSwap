...
import { DneroswapSquadContext } from 'views/DneroswapSquad/context'
...
const BuyTicketsButtons: React.FC<React.PropsWithChildren<BuyTicketsProps>> = ({
  ...
  const { isUserEnabled, setIsUserEnabled } = useContext(DneroswapSquadContext)
  ...
  const [onPresentEnableModal, onDismissEnableModal] = useModal(
    <ConfirmModal
      ...
      loadingText={t('Please enable WDNERO spending in your wallet')}
