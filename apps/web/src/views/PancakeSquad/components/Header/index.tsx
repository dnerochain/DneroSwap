...
import { Box, Flex, lightColors, Spinner, Text, Timeline } from '@dneroswap/uikit'
import { useTranslation } from '@dneroswap/localization'
import { useDNEROWDneroBalance } from 'hooks/useTokenBalance'
import useTheme from 'hooks/useTheme'
import { StyledWaveContainer } from 'views/DneroswapSquad/styles'
...
import { DneroswapSquadHeaderType } from './types'

const DEFAULT_WDNERO_COST = 15
const DEFAULT_MAX_TICKETS = 10

const DneroswapSquadHeader: React.FC<React.PropsWithChildren<DneroswapSquadHeaderType>> = ({
  userInfos,
  eventInfos,
  account,
  userStatus,
  ...
  const { balance: wdneroBalance } = useDNEROWDneroBalance()
  ...
  return (
    ...
    >
      ...
      <Text color={lightColors.warning} textAlign="center" bold>
        {t('Mint Cost: %minCost% WDNERO each', {
          minCost: DEFAULT_WDNERO_COST,
        })}
      </Text>
      <Text color={lightColors.warning} textAlign="center" bold>
      ...
      <Text color={lightColors.invertedContrast} textAlign="center">
        {t('DneroSwap’s first official generative NFT collection.')}
      </Text>
...
export default DneroswapSquadHeader
