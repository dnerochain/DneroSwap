...
import { Box, Button, Card, CardBody, Flex, Step, Stepper, Text } from '@dneroswap/uikit'
import { useTranslation } from '@dneroswap/localization'
import { StyledWaveContainer, LandingBodyWrapper } from 'views/DneroswapSquad/styles'
...
const EventStepsSection: React.FC<React.PropsWithChildren<EventStepsProps>> = ({
  ...
  const stepsConfig = stepsConfigBuilder({ t, eventInfos, userInfos, userStatus, account, theme, wdneroBalance })
    ...
    <StyledEventStepsSectionContainer justifyContent="center" $isDark={isDark}>
      ...
      <StyledWaveContainer bottom="-3px">
        <Flex justifyContent="center">
          <StyledBunniesSquadImg src="/images/dneroswapSquad/squadRow.png" alt="pancake bunnies squad" />
        </Flex>
