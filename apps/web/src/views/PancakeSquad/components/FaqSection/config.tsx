...
const config = ({ t }: FAQsType) => [
  ...
  },
  {
    ...
    description: [
      t(
        'Wait for the reveal! After all 10,000 members of the Dneroswap Squad have been minted, their images will remain hidden for a few days. Just be patient :)',
      ),
    ],
  },
  {
    ...
    description: [
      ...
      t(
        'Users holding Gen 0 Dneroswap Bunny NFTs at the snapshot may also purchase one additional Dneroswap Squad NFT in the presale for each Dneroswap Bunny they hold.',
      ),
      t(
  ...
  },
  {
    ...
    description: [t('100% of WDNERO spent on Dneroswap Squad NFTs will be burned as part of our weekly WDNERO burn.')],
  },
  {
