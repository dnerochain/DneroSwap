import { InjectedModalProps, Modal } from '@dneroswap/uikit'
import { useTranslation, ContextApi } from '@dneroswap/localization'
import useEditProfile, { Views } from './reducer'
import StartView from './StartView'
import PauseProfileView from './PauseProfileView'
import ChangeProfilePicView from './ChangeProfilePicView'
import ApproveWDneroView from './ApproveWDneroView'
  ...
  return (
    ...
    >
      <div style={{ maxWidth: '400px' }}>
        ...
        {currentView === Views.APPROVE && <ApproveWDneroView goToChange={goToChange} onDismiss={onDismiss} />}
      </div>
    </Modal>
  )
}
