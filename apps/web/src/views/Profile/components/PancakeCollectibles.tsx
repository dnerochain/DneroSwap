import { Grid, Heading, PageHeader } from '@dneroswap/uikit'
...
const DneroswapCollectibles = () => {
  const { t } = useTranslation()
  const { data: collections, status } = useSWR<Collection[]>(['dneroswapCollectibles'])

  return (
    <>
      <PageHeader>
        <Heading as="h1" scale="xxl" color="secondary" data-test="nft-collections-title">
          {t('Dneroswap Collectibles')}
        </Heading>
      </PageHeader>
      <Page>
...
export default DneroswapCollectibles
