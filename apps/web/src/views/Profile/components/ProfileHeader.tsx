...
import { NextLinkFromReactRouter as ReactRouterLink } from '@dneroswap/widgets-internal'
...
const ProfileHeader: React.FC<React.PropsWithChildren<HeaderProps>> = ({
  ...
  const bannerImage = useMemo(() => {
    ...
    switch (profileTeamId) {
      ...
      case 3:
        return `${imagePath}/wdnerors-banner.png`
      default:
        break
    }
        ...
        <Flex display="inline-flex">
          {accountPath && (
            <IconButton
              ...
              // @ts-ignore
              alt={t('View DneroScan for user address')}
            />
          )}
        </Flex>
      )
