...
const useAllTradingRewardPair = ({ status, type }: UseAllTradingRewardPairProps): AllTradingRewardPair => {
  const tradingRewardContract = useTradingRewardContract({ chainId: ChainId.DNERO })
  const tradingRewardTopTradersContract = useTradingRewardTopTraderContract({ chainId: ChainId.DNERO })
  const contract = type === RewardType.WDNERO_STAKERS ? tradingRewardContract : tradingRewardTopTradersContract
