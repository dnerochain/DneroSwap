...
import { Text, Flex, Skeleton } from '@dneroswap/uikit'
...
const { V3Tag, V3FeeTag, EthTag, DneroTag, ZkEVMTag, ZkSyncTag, ArbTag, BaseTag, LineaTag } = FarmWidget.Tags
        ...
        <Flex width="100%">
          ...
          <Flex ml={['auto', 'auto', 'auto', 'auto', '4px']}>
            ...
            <Flex ml="4px">
              ...
              {chainId === ChainId.DNERO && <DneroTag />}
