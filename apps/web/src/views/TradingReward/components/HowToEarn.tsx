...
import { Box, Flex, Text, Card, LinkExternal } from '@dneroswap/uikit'
...
const stepList = [
  ...
  },
  {
    ...
    subTitle: (
      <Trans>
        Start trading any eligible pairs to earn rewards in WDNERO. The more you trade, the more rewards you will earn
