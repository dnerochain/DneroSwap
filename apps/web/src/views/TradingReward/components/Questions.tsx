...
import { Card, CardBody, Text, Flex, Link } from '@dneroswap/uikit'
        ...
        <Card style={{ width: '100%' }}>
          <StyledCardBody>
            ...
            >
              <StyledListText color="textSubtle">
                {t(
                  'Each campaign has its own eligibility requirements, like the unlock time of the WDNERO staking position.',
                )}
              </StyledListText>
              <StyledListText color="textSubtle">
                {t(
                  'You may need to extend your locked WDNERO staking position. Please follow the instructions on the page.',
                )}
              </StyledListText>
            </FoldableText>
          </StyledCardBody>
