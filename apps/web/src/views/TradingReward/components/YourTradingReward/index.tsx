...
import { Box, Flex, Text, Skeleton } from '@dneroswap/uikit'
import { useAccount } from 'wagmi'
import { useTranslation } from '@dneroswap/localization'
import BigNumber from 'bignumber.js'
import { useProfile } from 'state/profile/hooks'
import { DeserializedLockedWDneroVault } from 'state/types'
import { getVaultPosition, VaultPosition } from 'utils/wdneroPool'
import { useWDneroVault, useFetchIfo as useWDneroVaultPool } from 'state/pools/hooks'
...
const YourTradingReward: React.FC<React.PropsWithChildren<YourTradingRewardProps>> = ({
  ...
  const { userData } = useWDneroVault() as DeserializedLockedWDneroVault
