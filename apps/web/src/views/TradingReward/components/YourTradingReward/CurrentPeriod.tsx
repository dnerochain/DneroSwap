...
import { Box, Card, Text } from '@dneroswap/uikit'
...
import NoWDneroLockedOrExtendLock from 'views/TradingReward/components/YourTradingReward/NoWDneroLockedOrExtendLock'
...
const CurrentPeriod: React.FC<React.PropsWithChildren<CurrentPeriodProps>> = ({
  ...
  const pool = useDeserializedPoolByVaultKey(VaultKey.WDneroVault)
