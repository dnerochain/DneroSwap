import { MANAGER, Strategy } from '@dneroswap/position-managers'
import { Currency, CurrencyAmount, Percent, Price } from '@dneroswap/sdk'
import { Card, CardBody } from '@dneroswap/uikit'
...
export const DuoTokenVaultCard = memo(function DuoTokenVaultCard({
  ...
  const withWDneroReward: boolean = useMemo(() => earningToken.symbol === 'WDNERO', [earningToken])
    ...
    <StyledCard>
      ...
      <CardBody>
        <YieldInfo
          ...
          autoCompound={autoCompound}
          withWDneroReward={withWDneroReward}
        ...
        <LiquidityManagement
          ...
          userLpAmounts={userLpAmounts}
          precision={precision}
          isInWDneroRewardDateRange={apr.isInWDneroRewardDateRange}
          totalStakedInUsd={totalStakedInUsd}
