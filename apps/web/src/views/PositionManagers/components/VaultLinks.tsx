...
import { FlexProps, Flex, ScanLink } from '@dneroswap/uikit'
import { ChainId } from '@dneroswap/chains'
import { useActiveChainId } from 'hooks/useActiveChainId'
import { useTranslation } from '@dneroswap/localization'
import { MANAGER } from '@dneroswap/position-managers'
...
const LinkSupportChains = [ChainId.DNERO, ChainId.DNERO_TESTNET]
...
export const VaultLinks = memo(function VaultLinks({
  ...
  const useDneroCoinFallback = useMemo(() => (chainId ? LinkSupportChains.includes(chainId) : false), [chainId])
  ...
  return (
    <LinkContainer flexDirection={layout} {...props}>
      ...
      <StyledScanLink
        ...
        useDneroCoinFallback={useDneroCoinFallback}
      >
