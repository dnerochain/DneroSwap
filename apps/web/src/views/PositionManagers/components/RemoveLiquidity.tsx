...
import type { AtomBoxProps } from '@dneroswap/uikit'
import { Box, Button, Flex, ModalV2, RowBetween, Text, useToast } from '@dneroswap/uikit'
...
import { ConfirmationPendingContent, CurrencyLogo } from '@dneroswap/widgets-internal'
