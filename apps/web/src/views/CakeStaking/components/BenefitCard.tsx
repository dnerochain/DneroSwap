import { Trans, useTranslation } from '@dneroswap/localization'
import { Button, Card, Flex, FlexGap, Heading, Link, Text } from '@dneroswap/uikit'
import styled from 'styled-components'

type BenefitCardType = 'earnWDnero' | 'gaugesVoting' | 'farmBoost' | 'snapshotVoting' | 'ifo' | 'more'
...
export const BENEFITS: Record<BenefitCardType, BenefitItem> = {
  earnWDnero: {
    headImg: '/images/wdnero-staking/benefit-earn-wdnero.png',
    title: <Trans>Earn WDNERO</Trans>,
    subTitle: <Trans>Total Distributed</Trans>,
    btnText: <Trans>Check Reward</Trans>,
    desc: ['Weekly revenue sharing', 'Weekly WDNERO pool rewards'],
  },
  gaugesVoting: {
    headImg: '/images/wdnero-staking/benefit-gauges-voting.png',
  ...
  farmBoost: {
    headImg: '/images/wdnero-staking/benefit-farm-boost.png',
  ...
  snapshotVoting: {
    headImg: '/images/wdnero-staking/benefit-snapshot-voting.png',
    title: <Trans>Snapshot Voting</Trans>,
    subTitle: <Trans>Number of Proposals</Trans>,
    btnText: <Trans>Check Snapshot Voting</Trans>,
    link: '/voting',
    desc: ['Use your veWDNERO to vote on important governance proposals'],
  },
  ifo: {
    headImg: '/images/wdnero-staking/benefit-ifo.png',
  ...
  more: {
    headImg: '/images/wdnero-staking/benefit-more.png',
    ...
    <StyledCard innerCardProps={{ p: ['16px', '16px', '24px'] }}>
      <FlexGap flexDirection="column" gap="16px" height="100%" justifyContent="space-between">
        <FlexGap gap="16px" alignItems="center">
          <HeadImage>
            <img srcSet={`${info.headImg} 2x`} alt="earn-wdnero" />
          </HeadImage>
