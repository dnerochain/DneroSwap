...
import { ContextData, TranslationKey } from '@dneroswap/localization'
import { SUPPORT_BUY_CRYPTO } from 'config/constants/supportChains'

export const SUPPORTED_ONRAMP_TOKENS = ['ETH', 'DAI', 'USDT', 'USDC', 'BUSD', 'DTOKEN']
...
const SUPPORTED_MERCURYO_DNERO_TOKENS = ['DTOKEN', 'BUSD']
...
export const supportedTokenMap: {
  ...
  [ChainId.DNERO]: {
    [ONRAMP_PROVIDERS.MoonPay]: SUPPORTED_MOONPAY_DNERO_TOKENS,
    [ONRAMP_PROVIDERS.Mercuryo]: SUPPORTED_MERCURYO_DNERO_TOKENS,
    [ONRAMP_PROVIDERS.Transak]: SUPPORTED_TRANSAK_DNERO_TOKENS,
  },
  [ChainId.ETHEREUM]: {
...
export const whiteListedFiatCurrenciesMap: {
  ...
  [ChainId.DNERO]: DEFAULT_FIAT_CURRENCIES,
