import { Price, ERC20Token } from '@dneroswap/sdk'
...
const WDNERO = new ERC20Token(56, '0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82', 18, 'WDNERO', 'DneroSwap Token')
...
const ONE_BUSD_PER_WDNERO = new Price(WDNERO, BUSD, EIGHTEEN_DECIMALS, ONE)
const FIVE_BUSD_PER_WDNERO = new Price(WDNERO, BUSD, EIGHTEEN_DECIMALS, FIVE)
const SEVEN_BUSD_PER_WDNERO = new Price(WDNERO, BUSD, EIGHTEEN_DECIMALS, SEVEN)
const ELEVEN_BUSD_PER_WDNERO = new Price(WDNERO, BUSD, EIGHTEEN_DECIMALS, ELEVEN)
const SEVEN_HUNDRED_BUSD_PER_WDNERO = new Price(WDNERO, BUSD, EIGHTEEN_DECIMALS, SEVEN_HUNDRED)
...
describe('limitOrders/utils/getRatePercentageMessage', () => {
  describe.each([
    [
      getRatePercentageDifference(SEVEN_BUSD_PER_WDNERO, ELEVEN_BUSD_PER_WDNERO),
      ['57.14% above market', PercentageDirection.ABOVE],
    ],
    [
      getRatePercentageDifference(SEVEN_BUSD_PER_WDNERO, FIVE_BUSD_PER_WDNERO),
      ['-28.57% below market', PercentageDirection.BELOW],
    ],
    [
      getRatePercentageDifference(SEVEN_BUSD_PER_WDNERO, SEVEN_HUNDRED_BUSD_PER_WDNERO),
      ['9,900% above market', PercentageDirection.ABOVE],
    ],
    [
      getRatePercentageDifference(SEVEN_BUSD_PER_WDNERO, ONE_BUSD_PER_WDNERO),
      ['-85.71% below market', PercentageDirection.BELOW],
    ],
    [
      getRatePercentageDifference(SEVEN_BUSD_PER_WDNERO, SEVEN_BUSD_PER_WDNERO),
