...
import { Currency, CurrencyAmount, Percent, Token, Trade, TradeType } from '@dneroswap/sdk'
import { BottomDrawer, Box, Button, Flex, Link, useMatchBreakpoints, useModal, AutoColumn } from '@dneroswap/uikit'
...
import { SUPPORT_ONLY_DNERO } from 'config/constants/supportChains'
...
const LimitOrders = () => {
  ...
  const isAccessTokenSupported = SUPPORT_ONLY_DNERO.includes(chainId)
