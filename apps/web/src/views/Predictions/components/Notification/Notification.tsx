...
import { Card, CardBody, Heading, ArrowBackIcon, IconButton } from '@dneroswap/uikit'
  ...
  return (
    <Wrapper>
      <CardWrapper>
        ...
        <BunnyDecoration
          onClick={() => {
            if (token.symbol === PredictionSupportedSymbol.WDNERO) {
              router.query.token = PredictionSupportedSymbol.DTOKEN
            } else if (token.symbol === PredictionSupportedSymbol.DTOKEN) {
