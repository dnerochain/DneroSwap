...
import { Flex, Box, Card, Text, useMatchBreakpoints, Balance, ButtonTabMenu } from '@dneroswap/uikit'
...
const Pot: React.FC<React.PropsWithChildren> = () => {
  ...
  const prizeInBusd = publicData.totalPrize.times(wdneroPriceBusd)
          ...
          <Flex mt="48px" alignItems="flex-start">
            <Card style={{ width: isMobile ? '100%' : '436px' }}>
              ...
              <Box>
                <CardHeader
                  title={t('Pottery')}
                  subTitle={t('Stake WDNERO, Earn WDNERO, Win WDNERO')}
