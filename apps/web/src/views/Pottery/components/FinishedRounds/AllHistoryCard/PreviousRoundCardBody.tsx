...
import { Box, Flex, Text, CardBody, CardRibbon, Skeleton, Balance, ScanLink } from '@dneroswap/uikit'
...
const PreviousRoundCardBody: React.FC<React.PropsWithChildren<PreviousRoundCardBodyProps>> = ({
  ...
  const prizeInBusd = new BigNumber(prize).times(wdneroPriceBusd).toNumber()
