...
import { Modal, Text, Box, Flex, BalanceInput } from '@dneroswap/uikit'
...
const WinRateModal: React.FC<React.PropsWithChildren<WinRateModalProps>> = ({
  ...
  const {
    ...
    setCalculatorMode,
    setTargetWinRate,
  } = useWinRateCalculator({ wdneroPrice, totalSupply })
  ...
  const editingUnit = editingCurrency === EditingCurrency.TOKEN ? 'WDNERO' : 'USD'
  const editingValue = editingCurrency === EditingCurrency.TOKEN ? principalAsToken : principalAsUSD
  const conversionUnit = editingCurrency === EditingCurrency.TOKEN ? 'USD' : 'WDNERO'
