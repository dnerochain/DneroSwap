...
import { Box, Message, MessageText, Text, Link } from '@dneroswap/uikit'
    ...
    <Box position="relative">
      <Box padding="0 16px" margin="10px auto" width={['100%', '100%', '100%', '800px']}>
        <Message variant="warning">
          <MessageText>
            <Text as="span">{t('Dneroswap Pottery (BETA) is indefinitely halted. Please refer')}</Text>
            <Link
              style={{ display: 'inline-block' }}
              m="0 4px"
              external
              href="https://blog.pancakeswap.finance/articles/idefinitely-halt-of-dneroswap-swap-pottery-beta-product"
            >
              {t('here')}
            </Link>
