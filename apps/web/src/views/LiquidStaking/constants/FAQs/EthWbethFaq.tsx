...
import { Link, LinkExternal } from '@dneroswap/uikit'
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <Trans>
          DneroSwap is also working to support a conversion contract on our liquid staking page to convert wBETH back
          to ETH seamlessly.
        </Trans>
      </>
    ),
