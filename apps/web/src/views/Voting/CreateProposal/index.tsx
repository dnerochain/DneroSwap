...
import { ADMINS, DNEROSWAP_SPACE, VOTE_THRESHOLD } from '../config'
              ...
              <CardBody>
                ...
                {account && (
                  <Flex alignItems="center" mb="8px">
                    ...
                    <ScanLink useDneroCoinFallback href={getBlockExploreLink(account, 'address')}>
                ...
                <Flex alignItems="center" mb="16px">
                  ...
                  <ScanLink useDneroCoinFallback href={getBlockExploreLink(snapshot, 'block')}>
                    {snapshot}
                  </ScanLink>
                </Flex>
                {account ? (
