import { Box, Card, CardBody, CardHeader, Flex, Heading, LinkExternal, ScanLink, Text } from '@dneroswap/uikit'
    ...
    <Card mb="16px">
      ...
      <CardBody>
        ...
        <Flex alignItems="center" mb="8px">
          ...
          <ScanLink useDneroCoinFallback href={getBlockExploreLink(proposal.author, 'address')} ml="8px">
            {truncateHash(proposal.author)}
          </ScanLink>
        </Flex>
        <Flex alignItems="center" mb="16px">
          <Text color="textSubtle">{t('Snapshot')}</Text>
          <ScanLink useDneroCoinFallback href={getBlockExploreLink(proposal.snapshot, 'block')} ml="8px">
            {proposal.snapshot}
          </ScanLink>
        </Flex>
        <DetailBox p="16px">
