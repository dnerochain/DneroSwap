...
import { Currency, CurrencyAmount, Percent } from '@dneroswap/swap-sdk-core'
import { AddIcon, Box, Button, ChevronRightIcon, Flex, IconButton, MinusIcon, Text } from '@dneroswap/uikit'
      ...
      {shouldUnlock ? null : (
        <Flex>
          ...
          >
            {(openModal) => (
              <IconButton
                disabled={pool.token.equals(dneroTokens.wdnero) || currentDay + lockPeriod > poolEndDay}
                variant="secondary"
                onClick={openModal}
              >
