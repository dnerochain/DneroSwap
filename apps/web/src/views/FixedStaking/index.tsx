...
import { Flex, FlexLayout, Heading, PageHeader, ToggleView, ViewMode } from '@dneroswap/uikit'
...
const FixedStaking = () => {
  ...
  const sortedPoolGroup = useMemo(() => {
    const [first, last] = partition(Object.keys(poolGroup), (poolAddress) =>
      [dneroTokens.wdtoken.address, dneroTokens.wdnero.address].includes(poolAddress as Address),
    )
