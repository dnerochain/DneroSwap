import { Box, Button, Flex, Skeleton, Text, CalculateIcon, useModal, Balance } from '@dneroswap/uikit'
...
interface WDneroVaultAprProps {
  pool: Pool.DeserializedPool<Token>
  userData: DeserializedVaultUser
  vaultPosition: VaultPosition
}

const WDneroVaultApr: React.FC<React.PropsWithChildren<WDneroVaultAprProps>> = ({ pool, userData, vaultPosition }) => {
