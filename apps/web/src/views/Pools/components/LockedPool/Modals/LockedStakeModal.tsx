...
import { Box, Modal } from '@dneroswap/uikit'
import { getBalanceNumber, getDecimalAmount } from '@dneroswap/utils/formatBalance'
...
const LockedStakeModal: React.FC<React.PropsWithChildren<GenericModalProps>> = ({
  ...
  return (
    <RoiCalculatorModalProvider lockedAmount={lockedAmount}>
      <Modal title={t('Lock WDNERO')} onDismiss={onDismiss} headerBackground={theme.colors.gradientCardHeader}>
        <Box mb="16px">
          <BalanceField
