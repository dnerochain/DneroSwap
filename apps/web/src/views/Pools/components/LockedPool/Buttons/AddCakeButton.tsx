...
import { Button, useModal, Skeleton, ButtonProps } from '@dneroswap/uikit'
...
const AddWDneroButton: React.FC<React.PropsWithChildren<AddButtonPropsType>> = ({
  currentBalance,
  stakingToken,
  currentLockedAmount,
  lockEndTime,
...
export default memo(AddWDneroButton)
