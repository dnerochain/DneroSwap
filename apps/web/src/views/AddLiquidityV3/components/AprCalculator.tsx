...
import { Currency, CurrencyAmount, Price, Token, ZERO } from '@dneroswap/sdk'
import { CalculateIcon, Flex, IconButton, QuestionHelper, RocketIcon, Text, TooltipText } from '@dneroswap/uikit'
import { BIG_ZERO } from '@dneroswap/utils/bigNumber'
import { formatPrice } from '@dneroswap/utils/formatFractions'
import { FeeCalculator, Pool, encodeSqrtRatioX96, isPoolTickInRange, parseProtocolFees } from '@dneroswap/v3-sdk'
import {
  RoiCalculatorModalV2,
  RoiCalculatorPositionInfo,
  useAmountsByUsdValue,
  useRoi,
} from '@dneroswap/widgets-internal/roi'
import { useWDneroPrice } from 'hooks/useWDneroPrice'
import { useRouter } from 'next/router'
import { useCallback, useMemo, useState } from 'react'
import { styled } from 'styled-components'

import { PositionDetails, getPositionFarmApr, getPositionFarmAprFactor } from '@dneroswap/farms'
...
import { useUserPositionInfo } from 'views/Farms/components/YieldBooster/hooks/bWDneroV3/useBWDneroV3Info'
import { BoostStatus, useBoostStatus } from 'views/Farms/components/YieldBooster/hooks/bWDneroV3/useBoostStatus'
...
export function AprCalculator({
  ...
  const { positionFarmApr, positionFarmAprFactor } = useMemo(() => {
    if (!farm || !wdneroPrice || !positionLiquidity || !amount0 || !amount1 || !inRange) {
      return {
        positionFarmApr: '0',
        positionFarmAprFactor: BIG_ZERO,
      }
    }
    const { farm: farmDetail, wdneroPerSecond } = farm
  ...
  }, [farm, wdneroPrice, positionLiquidity, amount0, amount1, inRange])
  ...
  return (
    <>
      ...
      <RoiCalculatorModalV2
        ...
        wdneroAprFactor={positionFarmAprFactor.times(isBoosted ? boostMultiplier : 1)}
