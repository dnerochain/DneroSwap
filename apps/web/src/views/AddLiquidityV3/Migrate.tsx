...
import { LiquidityChartRangeInput } from '@dneroswap/widgets-internal'
...
import { CurrencyAmount, ERC20Token, Fraction, NATIVE, Pair, Price, WNATIVE, ZERO } from '@dneroswap/sdk'
import { useUserSlippagePercent } from '@dneroswap/utils/user'
import { FeeAmount, Pool, Position, priceToClosestTick, TickMath } from '@dneroswap/v3-sdk'
          ...
          {noLiquidity && (
            <AtomBox>
              <Message variant="warning">
                <MessageText>
                  {t(
                    'You are the first liquidity provider for this DneroSwap V3 pool. Your liquidity will migrate at the current V2 price.',
                  )}
                  <MessageText>
          ...
          {largePriceDifference ? (
            <GreyCard>
              ...
              <Text fontSize={14} style={{ marginTop: 8, fontWeight: 400 }}>
                {t('You should only deposit liquidity into DneroSwap V3 at a price you believe is correct.')} <br />
                {t(
