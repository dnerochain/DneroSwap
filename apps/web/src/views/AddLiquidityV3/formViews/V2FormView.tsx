...
import { useIsExpertMode } from '@dneroswap/utils/user'
import { useTranslation } from '@dneroswap/localization'
import { ReactNode, useCallback, useMemo } from 'react'
import { Percent, Pair } from '@dneroswap/sdk'
...
import { InfoBox } from '@dneroswap/widgets-internal'
        ...
        {isOneWeiAttack ? (
          <Message variant="warning">
            <Flex flexDirection="column">
              <MessageText>
                {t(
                  'Adding liquidity to this V2 pair is currently not available on DneroSwap UI. Please follow the instructions to resolve it using blockchain explorer.',
                )}
              </MessageText>
              <LinkExternal
              ...
              <ScanLink
                useDneroCoinFallback={ChainLinkSupportChains.includes(chainId)}
