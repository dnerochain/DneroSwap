...
import { CurrencyAmount, WNATIVE } from '@dneroswap/sdk'
import {
  AutoRow,
  CardBody,
  Heading,
...
import { ConfirmationModalContent } from '@dneroswap/widgets-internal'

import { NonfungiblePositionManager, MasterChefV3 } from '@dneroswap/v3-sdk'
...
import { useDebouncedChangeHandler } from '@dneroswap/hooks'
        ...
        <CardBody>
          ...
          {isStakedInMCv3 ? (
            <Message variant="primary" mb="20px">
              {t(
                'This liquidity position is currently staking in the Farm. Adding or removing liquidity will also harvest any unclaimed WDNERO to your wallet.',
              )}
            </Message>
          ) : null}
