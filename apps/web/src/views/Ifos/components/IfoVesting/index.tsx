...
import { Box, Card, CardBody, CardHeader, Flex, Text, Image, IfoNotTokens } from '@dneroswap/uikit'
    ...
    <StyleVestingCard isActive>
      ...
      <VestingCardBody>
        {cardStatus.status === VestingStatus.NOT_TOKENS_CLAIM && (
          <IfoNotTokens
            participateText={t(
              'Participate in our next IFO. and remember to lock your WDNERO to increase your allocation!',
            )}
          />
        )}
