...
import { Link, Box } from '@dneroswap/uikit'
...
const config = [
    ...
    description: [
      ...
      <Box mt="1rem">
        <Trans>
          ...
          card. Each eligible participant will be able to commit any amount of WDNERO up to the maximum commit limit,
          which is published along with the IFO voting proposal.
        </Trans>
      </Box>,
      <Box mt="1rem">
        <Trans>
          In the Public Sale, everyone with an active DneroSwap profile can commit. However the maximum amount of WDNERO
          users can commit, is equal to the number of iWDNERO they have.
        </Trans>
      </Box>,
      <Box mt="1rem">
        <Trans>Learn more about iWDNERO</Trans>
        <InlineLink ml="4px" external href="https://docs.pancakeswap.finance/products/ifo-initial-farm-offering/iwdnero">
          <Trans>here</Trans>
        </InlineLink>
      </Box>,
      <Box mt="1rem">
  ...
  {
    title: <Trans>How can I get more iWDNERO?</Trans>,
    description: [
      <Trans>
        Your iWDNERO number for each IFOs is calculated based on your veWDNERO balance at the snapshot time of each IFOs.
        Usually the snapshot time is the end time of each IFOs. Therefore, iWDNERO can varies between different IFOs.
      </Trans>,
      <Box mt="1rem">
        <Trans>
          To get more iWDNERO, simply get more veWDNERO by locking more WDNERO in your veWDNERO position, or extending your
          veWDNERO position.
        </Trans>
      </Box>,
    ],
  },
  {
    ...
    description: [
      ...
      <Box mt="1rem">
        <Trans>
          Just remember: you need an active DneroSwap Profile in order to participate in Private and Public Sales.
        </Trans>
      </Box>,
    ],
  },
  ...
  },
  {
    ...
    description: [<Trans>The WDNERO from the participation fee will be burnt as part of the weekly token burn.</Trans>],
  },
  {
    title: <Trans>How can I get an achievement for participating in the IFO?</Trans>,
    description: [
      <Trans>
        You need to contribute a minimum of about 10 USD worth of WDNERO to either sale. You can contribute to one or
        both, it doesn’t matter: only your overall contribution is counted for the achievement.
      </Trans>,
      <Box mt="1rem">
        <Trans>Note that only DneroChain IFOs are eligible for achievements.</Trans>
      </Box>,
    ],
  },
  {
