...
import { formatNumber, getBalanceAmount } from '@dneroswap/utils/formatBalance'
...
// Default value for transaction setting, tweak based on DNERO network congestion.
...
const ContributeModal: React.FC<React.PropsWithChildren<Props>> = ({
  ...
  const label = cake ? t('Max. WDNERO entry') : t('Max. token entry')
      ...
      <ModalBody maxWidth="360px">
        <Box p="2px">
          ...
          <Text color="textSubtle" fontSize="12px" mb="24px">
            {t(
              'If you don’t commit enough WDNERO, you may not receive a meaningful amount of IFO tokens, or you may not receive any IFO tokens at all.',
            )}
            <Link
              fontSize="12px"
              display="inline"
