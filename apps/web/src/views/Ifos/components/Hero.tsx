...
import { Box, Button, Container, Flex, Heading, Text, useMatchBreakpoints } from '@dneroswap/uikit'
import { useRouter } from 'next/router'
import { useActiveChainId } from 'hooks/useActiveChainId'
import { useMemo } from 'react'
import { isIfoSupported } from '@dneroswap/ifos'
        ...
        <Container position="relative" zIndex="2">
          ...
          >
            <Box>
              ...
              <StyledSubTitle bold>{t('Buy new tokens launching on DNEROCHAIN')}</StyledSubTitle>
            </Box>
            {isMobile ? (
...
function HeaderBunny() {
  ...
  const bunnyImageUrl = useMemo(() => {
    const chainId = isIfoSupported(currentChainId) ? currentChainId : ChainId.DNERO
