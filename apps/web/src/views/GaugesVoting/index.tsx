...
import { MyVeWDneroBalance } from './components/MyVeWDneroBalance'
            ...
            <Box maxWidth={['200px', '200px', '537px']}>
              <Flex flexDirection={['column', 'column', 'row']}>
                <Text color="textSubtle" maxWidth={['142px', '100%', '100%']}>
                  {t('Use veWDNERO to vote and determine WDNERO emissions.')}
                </Text>
                <Box ml={['-8px', '-8px', 0]}>
                  <InlineLink
                    external
                    showExternalIcon
                    color="textSubtle"
                    href="https://docs.pancakeswap.finance/products/vewdnero"
                  >
                    {t('Learn More')}
                  </InlineLink>
                </Box>
