...
import { Heading, Text, Flex, Box, useMatchBreakpoints, ChevronLeftIcon, ChevronRightIcon } from '@dneroswap/uikit'
...
const IntroSteps = [
  ...
  },
  {
    ...
    description: (
      <Trans>
        Earn WDNERO tokens on most trades made on DneroSwap. Stake for more rewards or use them in our Lottery and
        Pottery
      </Trans>
    ),
  },
