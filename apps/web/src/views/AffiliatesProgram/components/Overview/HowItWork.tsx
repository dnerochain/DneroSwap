import { Flex, Heading, Text, Card, Box } from '@dneroswap/uikit'
  ...
  return (
    ...
    >
      ...
      <Text textAlign="center" color="textSubtle">
        {t('Together we can make the DneroSwap community even stronger')}
      </Text>
      <Text textAlign="center" color="textSubtle" bold mb="32px">
        {t('How do you Become a DneroSwap Affiliate?')}
      </Text>
        ...
        <Flex width={['100%', '100%', '100%', '33.33%']}>
          <Card>
            <Box padding={['24px']}>
              ...
              <Text fontSize={['14px']} mt="24px">
                {t('Earn up to 20% referral commissions in WDNERO')}
              </Text>
            </Box>
          </Card>
        </Flex>
