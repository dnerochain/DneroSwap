...
import { Card, CardBody, CardHeader, Heading, Text, Flex, PageSection, Link } from '@dneroswap/uikit'
    ...
    >
      <Wrapper>
        ...
        <Card>
          ...
          <StyledCardBody>
            <FoldableText title={t('What is the criteria to become a DneroSwap affiliate?')} mt="24px">
              ...
              <StyledListText color="textSubtle">
                {t('Strong understanding of DneroSwap and our ecosystem')}
              </StyledListText>
            </FoldableText>
            <FoldableText title={t('How do I earn commissions as an affiliate?')} mt="24px">
              ...
              <StyledListText ml="16px" color="textSubtle">
                {t('Pairs must be in the DneroSwap Token list for the following chains (')}
                <Link
                  external
              ...
              <StyledListText ml="16px" color="textSubtle">
                {t(
                  'Pairs must include at least 1 major token (i.e., DTOKEN, BTC, BUSD, ETH, MATIC, ARB, DAI, USDT and/or USDC',
                )}
              </StyledListText>
            </FoldableText>
