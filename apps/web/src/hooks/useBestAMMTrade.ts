...
import { useDebounce, usePropsChanged } from '@dneroswap/hooks'
import { Currency, CurrencyAmount, Native, TradeType } from '@dneroswap/sdk'
import {
    ...
    () =>
      SmartRouter.createQuoteProvider({
        ...
        multicallConfigs: {
          ...BATCH_MULTICALL_CONFIGS,
          [ChainId.DNERO]: {
            ...BATCH_MULTICALL_CONFIGS[ChainId.DNERO],
            defaultConfig: {
