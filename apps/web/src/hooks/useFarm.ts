import { createFarmFetcherV3, ComputedFarmConfigV3, fetchTokenUSDValues } from '@dneroswap/farms'
...
import { Currency, ERC20Token } from '@dneroswap/sdk'
  ...
  return useQuery(
    ...
    async () => {
      ...
      try {
        ...
        const { farmsWithPrice, wdneroPerSecond, poolLength } = data
