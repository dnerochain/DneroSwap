...
import { MintResponse, SwapResponse, BurnResponse, TokenDayData, PairDayData, DneroswapDayData } from './types'
...
export const mapDayData = (tokenDayData: TokenDayData | DneroswapDayData): ChartEntry => ({
