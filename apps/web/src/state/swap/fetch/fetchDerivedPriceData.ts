...
const SWAP_INFO_BY_CHAIN = {
  [ChainId.DNERO]: {
    ...
    // v3: V3_SUBGRAPH_URLS[ChainId.DNERO],
  },
  [ChainId.ETHEREUM]: {
    v2: INFO_CLIENT_ETH,
  ...
  [ChainId.DNERO_TESTNET]: {
    v3: V3_SUBGRAPH_URLS[ChainId.DNERO_TESTNET],
  },
  [ChainId.GOERLI]: {},
  ...
  [ChainId.OPDNERO]: {
    v2: INFO_CLIENT_WITH_CHAIN[ChainId.OPDNERO],
    v3: V3_SUBGRAPH_URLS[ChainId.OPDNERO],
  },
...
// Fetches derivedDToken values for tokens to calculate derived price
