...
import { bigIntToSerializedBigNumber } from '@dneroswap/utils/bigNumber'
...
const processViewLotterySuccessResponse = (
  ...
  const serializedWDneroPerBracket = wdneroPerBracket.map((wdneroInBracket) => bigIntToSerializedBigNumber(wdneroInBracket))
  ...
  return {
    ...
    priceTicketInWDnero: bigIntToSerializedBigNumber(priceTicketInWDnero),
    discountDivisor: discountDivisor?.toString(),
    treasuryFee: treasuryFee?.toString(),
    firstTicketId: firstTicketId?.toString(),
    amountCollectedInWDnero: bigIntToSerializedBigNumber(amountCollectedInWDnero),
    finalNumber,
    wdneroPerBracket: serializedWDneroPerBracket,
