...
export interface TokenMarketData {
  ...
  isTradable: boolean
  metadataUrl?: string
  latestTradedPriceInDTOKEN?: string
  tradeVolumeDTOKEN?: string
  totalTrades?: string
  otherId?: string
  updatedAt?: string
...
// Represents single NFT token, either Squad-like NFT or single DneroswapBunny.
