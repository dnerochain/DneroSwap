...
export enum NonDneroFarmStepType {
  STAKE = 'STAKE',
  UNSTAKE = 'UNSTAKE',
}

export interface NonDneroFarmTransactionStep {
  step: number
  chainId: number
...
export interface NonDneroFarmTransactionType {
  type: NonDneroFarmStepType
  status: FarmTransactionStatus
  amount: string
  lpAddress: string
  lpSymbol: string
  steps: NonDneroFarmTransactionStep[]
}
