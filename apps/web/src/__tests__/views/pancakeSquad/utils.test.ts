...
import { getAltText, getEventStepStatus, getEventText } from 'views/DneroswapSquad/utils'

const HOUR_IN_MS = 3600 * 1000

describe('DneroswapSquad/utils/getEventStepStatus', () => {
...
describe('DneroswapSquad/utils/getEventText', () => {
  it('Should return past status', () => {
    // Given
    const eventStatus = [SaleStatusEnum.Presale, SaleStatusEnum.Sale]
    const saleStatus = SaleStatusEnum.Claim
...
describe('DneroswapSquad/utils/getAltText', () => {
