import { BuyButtonsEnum } from 'views/DneroswapSquad/components/Buttons/types'
import { getBuyButton, getBuyButtonText } from 'views/DneroswapSquad/components/Buttons/utils'
import { SaleStatusEnum } from 'views/DneroswapSquad/types'

describe('DneroswapSquad/buttons/utils/getBuyButtonText', () => {
...
describe('DneroswapSquad/buttons/utils/getBuyButton', () => {
