import { ButtonsEnum } from 'views/DneroswapSquad/components/Header/types'
import { getCurrentButton } from 'views/DneroswapSquad/components/Header/utils'
import { SaleStatusEnum, UserStatusEnum } from 'views/DneroswapSquad/types'

describe('DneroswapSquad/Header/utils/getCurrentButton', () => {
