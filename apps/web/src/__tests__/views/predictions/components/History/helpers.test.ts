...
import { formatDToken, formatUsd, getMultiplier, getPayout } from 'views/Predictions/components/History/helpers'
...
describe('formatDToken', () => {
  it.each([
    ...
    [10.8829, '10.8829'],
    [10.88296, '10.8830'],
  ])('format %i DTOKEN correctly with 4 decimals', (value, expected) => {
    expect(formatDToken(value, 4)).toEqual(expected)
  })

  it('returns 0 if DTOKEN is undefined', () => {
    expect(formatDToken(undefined, 4)).toEqual('0')
  })
})
