...
import { translations } from '@dneroswap/localization'
...
const whitelist = [
  ...
  `Don't let that dopey smile deceive you... Churro's a master WDNERO chef!`,
  `Nommm... Oh hi, I'm just meditating on the meaning of WDNERO.`,
  `Three guesses what's put that twinkle in those eyes! (Hint: it's WDNERO)`,
  'These bunnies love nothing more than swapping pancakes. Especially on DNERO.',
  ...
  'Zap in %amount% DTOKEN for %symbol%',
  ...
  'Sort Title Z-A',
  'All articles',
  'Learn basics of DneroSwap',
  'Learn how',
  'You might also like',
  'Chef’s choice',
  'Recommended Readings by Chefs',
  'Latest News about DneroSwap and more!',
  'Gaming Announcements',
  'DneroSwap Gaming Community',
  'Gaming Community',
  ...
  'Start Building',
  'Build Games with DneroSwap Now',
  'Bring Your Game to Life on DneroSwap',
  ...
  'Integrate WDNERO tokens and NFTs to enrich the gaming experience',
  'Build Games with the most reputable global brand in the industry',
  'Explore Top Blockchains',
  'DneroSwap operates on 9 popular blockchains, welcoming developers from diverse ecosystems',
  ...
  'DneroSwap Gaming Marketplace',
  'Play, Build and Connect on DneroSwap',
  'Flagship',
  'Published By',
  'Publish Date: %date%',
  'Publisher:',
