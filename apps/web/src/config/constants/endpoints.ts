import { ChainId, V2_SUBGRAPHS, V3_SUBGRAPHS } from '@dneroswap/chains'

export const GRAPH_API_PROFILE = 'https://api.thegraph.com/subgraphs/name/pancakeswap/profile'
export const GRAPH_API_PREDICTION_DTOKEN = 'https://api.thegraph.com/subgraphs/name/pancakeswap/prediction-v2'
export const GRAPH_API_PREDICTION_WDNERO = 'https://api.thegraph.com/subgraphs/name/pancakeswap/prediction-wdnero'
...
export const INFO_CLIENT = 'https://proxy-worker-api.pancakeswap.com/dneroswap-exchange'
export const V3_DNERO_INFO_CLIENT = `https://open-platform.nodereal.io/${
...
export const BLOCKS_CLIENT_OPDNERO = 'https://opdnero-mainnet-graph.nodereal.io/subgraphs/name/pancakeswap/blocks'
...
export const BLOCKS_CLIENT_WITH_CHAIN = {
  ...
  [ChainId.OPDNERO]: BLOCKS_CLIENT_OPDNERO,
}
