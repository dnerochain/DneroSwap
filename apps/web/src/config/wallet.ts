import { WalletConfigV2 } from '@dneroswap/ui-wallets'
import { WalletFilledIcon } from '@dneroswap/uikit'
import { getTrustWalletProvider } from '@dneroswap/wagmi/connectors/trustWallet'
...
const walletsConfig = ({
  ...
  return [
    ...
    },
    {
      ...
      get installed() {
        return typeof window !== 'undefined' && Boolean(window.DneroChain)
      },
      connectorId: ConnectorNames.DNERO,
      guide: {
        desktop: 'https://www.dnerochain.org/en/binance-wallet',
      },
      downloadLink: {
        desktop: isFirefox
