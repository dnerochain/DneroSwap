export const tradingCompetitionMoDABI = [
  {
    inputs: [
      { internalType: 'address', name: '_dneroswapProfileAddress', type: 'address' },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256[5]', name: '_wdneroRewards', type: 'uint256[5]' },
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: 'uint256[5]', name: 'wdneroRewards', type: 'uint256[5]' },
