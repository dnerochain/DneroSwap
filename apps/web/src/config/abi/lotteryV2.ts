export const lotteryV2ABI = [
  {
    inputs: [
      { internalType: 'address', name: '_wdneroTokenAddress', type: 'address' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'priceTicketInWDnero', type: 'uint256' },
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_minPriceTicketInWDnero', type: 'uint256' },
      { internalType: 'uint256', name: '_maxPriceTicketInWDnero', type: 'uint256' },
    ],
    name: 'setMinAndMaxTicketPriceInWDnero',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_priceTicketInWDnero', type: 'uint256' },
      { internalType: 'uint256', name: '_discountDivisor', type: 'uint256' },
  ...
  },
  {
    ...
    outputs: [
      {
        components: [
          { internalType: 'enum DneroSwapLottery.Status', name: 'status', type: 'uint8' },
          { internalType: 'uint256', name: 'startTime', type: 'uint256' },
          { internalType: 'uint256', name: 'endTime', type: 'uint256' },
          { internalType: 'uint256', name: 'priceTicketInWDnero', type: 'uint256' },
          ...
          { internalType: 'uint256[6]', name: 'wdneroPerBracket', type: 'uint256[6]' },
          ...
          { internalType: 'uint256', name: 'amountCollectedInWDnero', type: 'uint256' },
          { internalType: 'uint32', name: 'finalNumber', type: 'uint32' },
        ],
        internalType: 'struct DneroSwapLottery.Lottery',
        name: '',
        type: 'tuple',
      },
    ],
