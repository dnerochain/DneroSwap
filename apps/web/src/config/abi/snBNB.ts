export const snDTokenABI = [
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: 'address', name: '_account', type: 'address' },
      { indexed: false, internalType: 'uint256', name: '_amountInDTokenX', type: 'uint256' },
    ],
  ...
  },
  {
    ...
    name: 'convertDTokenToSnDToken',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [{ internalType: 'uint256', name: '_amountInSnDToken', type: 'uint256' }],
    name: 'convertSnDTokenToDToken',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: 'uint256', name: 'amountInSnDToken', type: 'uint256' },
        ],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'address', name: '_snDToken', type: 'address' },
  ...
  {
    inputs: [],
    name: 'getSnDTokenWithdrawLimit',
    outputs: [{ internalType: 'uint256', name: '_snDTokenWithdrawLimit', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
