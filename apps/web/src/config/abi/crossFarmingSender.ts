export const crossFarmingSenderABI = [
  {
    inputs: [
      ...
      { internalType: 'address', name: '_oracle_dtoken', type: 'address' },
      { internalType: 'address', name: '_oracle_eth', type: 'address' },
      { internalType: 'uint256', name: '_oracle_dtoken_update_buffer', type: 'uint256' },
