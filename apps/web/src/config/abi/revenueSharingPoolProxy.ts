export const revenueSharingPoolProxyABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: 'address', name: '_user', type: 'address' },
      { indexed: true, internalType: 'address', name: '_oldRecipient', type: 'address' },
      { indexed: true, internalType: 'address', name: '_newRecipient', type: 'address' },
    ],
  ...
  },
  {
    inputs: [{ internalType: 'address', name: '_user', type: 'address' }],
    name: 'getRecipient',
    outputs: [{ internalType: 'address', name: '_recipient', type: 'address' }],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_amount', type: 'uint256' }],
    name: 'injectRewardForCurrentWeek',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
