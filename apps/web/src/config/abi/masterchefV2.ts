export const masterChefV2ABI = [
  {
    inputs: [
      ...
      { internalType: 'contract IBEP20', name: '_WDNERO', type: 'address' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'accWDneroPerShare', type: 'uint256' },
    ],
    name: 'UpdatePool',
    type: 'event',
  },
  ...
  {
    inputs: [],
    name: 'WDNERO_RATE_TOTAL_PRECISION',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [],
    name: 'MASTERCHEF_WDNERO_PER_BLOCK',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
