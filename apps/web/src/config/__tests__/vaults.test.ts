...
import { VAULTS_CONFIG_BY_CHAIN } from '@dneroswap/position-managers'
import { positionManagerAdapterABI, positionManagerWrapperABI } from '@dneroswap/position-managers/src/abi'
import { dneroswapV3PoolABI } from '@dneroswap/v3-sdk'
import { publicClient } from 'utils/client'
import { Address } from 'viem'
import { describe, expect, it } from 'vitest'

const mainnetVaults = [
  VAULTS_CONFIG_BY_CHAIN[ChainId.DNERO],
