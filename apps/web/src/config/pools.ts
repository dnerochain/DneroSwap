...
export const POOLS_FAST_REVALIDATE = {
  [ChainId.DNERO_TESTNET]: 10_000,
  [ChainId.DNERO]: 10_000,
  ...
  [ChainId.OPDNERO]: 10_000,
  [ChainId.OPDNERO_TESTNET]: 10_000,
  [ChainId.BASE]: 10_000,
...
export const POOLS_NORMAL_REVALIDATE = {
  [ChainId.DNERO_TESTNET]: 15_000,
  [ChainId.DNERO]: 15_000,
  [ChainId.ETHEREUM]: 20_000,
  [ChainId.GOERLI]: 20_000,
  ...
  [ChainId.LINEA]: 20_000,
  [ChainId.LINEA_TESTNET]: 20_000,
  [ChainId.OPDNERO]: 15_000,
  [ChainId.OPDNERO_TESTNET]: 15_000,
  [ChainId.BASE]: 15_000,
...
export const POOLS_SLOW_REVALIDATE = {
  [ChainId.DNERO_TESTNET]: 20_000,
  [ChainId.DNERO]: 20_000,
  ...
  [ChainId.OPDNERO]: 20_000,
  [ChainId.OPDNERO_TESTNET]: 20_000,
  [ChainId.BASE]: 20_000,
