import { WDNERO, USDC } from '@dneroswap/tokens'
...
const AddLiquidityPage = () => {
  ...
  const [currencyIdA, currencyIdB] = router.query.currency || [
    native.symbol,
    WDNERO[chainId]?.address ?? USDC[chainId]?.address,
  ]
...
const OLD_PATH_STRUCTURE = /^(0x[a-fA-F0-9]{40}|DTOKEN)-(0x[a-fA-F0-9]{40}|DTOKEN)$/
