...
import { Flex, Text, Link } from '@dneroswap/uikit'
...
const TermsOfService = () => {
  return (
    <Container>
      <Text as="h1">DneroSwap Terms of Service</Text>
      ...
      <Text as="p">
        ...
        limited to DneroChain, Aptos and Ethereum, that allow users to trade certain compatible digital assets (“the
        DneroSwap protocol” or the “Protocol”), among other services. The Website is one, but not the exclusive, means
      ...
      <Text as="p">
        ...
        source-available self-executing smart contracts that are deployed on various public blockchains, such as DTOKEN
        Chain, Aptos and Ethereum. DneroSwap does not control or operate any version of the Protocol on any blockchain
        ...
        DneroSwap team is not a liquidity provider into Protocol liquidity pools and liquidity providers are
        independent third parties. The Protocol was initially deployed on the DneroChain blockchain, and has since been
      ...
      <Text as="p">
        DneroSwap owns all intellectual property and other rights in the Website and its contents, including (but not
      ...
      <Text as="p">
        ...
        such as rarity scores, token explorer or token lists (which includes the DneroSwap default token list and
        DneroSwap expanded list hosted at tokenlists.org). We may also provide warning labels for certain tokens. The
      ...
      <Text as="p">
        ...
        of any other digital tokens which are transacted on DneroSwap.
      </Text>
      <Text as="p">
      ...
      <Text as="p">
        ...
        modifications to the Protocol are generally managed in a community-driven way by holders of the WDNERO token. No
      ...
      <Text as="p">
        ...
        potential dispute arises, you must contact us by sending an email to info@dneroswap.come so that we can
      ...
      <Text as="p">
        ...
        as otherwise expressly set forth in the terms of another offer by DneroSwap, you will be solely responsible to
