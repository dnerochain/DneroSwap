    ...
    <AffiliatesProgramLayout>
      <Container>
        ...
        <Text as="p">
          ...
          perpetual trades on the DNEROCHAIN and Ethereum chain only.
        </Text>
        <Text as="p">
        ...
        <Text as="p">4.2 All commissions will be paid out in WDNERO tokens.</Text>
        <Text as="p">
        ...
        <Text as="p">
          ...
          4.3(a) , we will calculate your commissions in WDNERO tokens using the prevailing USD price of WDNERO tokens at
          that time.
        </Text>
        ...
        <Text as="p">
          8.3 Any statements you make about DneroSwap must reflect your honest opinions, beliefs, or experiences and
        ...
        <Text as="p">
          14.1 DneroSwap reserves the right to terminate this Agreement in its entirety with or without cause,
        ...
        <Text as="p">
          14.2 DneroSwap, in its sole discretion, reserves the right to suspend or terminate your account and refuse
        ...
        <Text as="p">14.3 DneroSwap reserves the right to refuse service to anyone for any reason at any time.</Text>
