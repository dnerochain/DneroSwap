import { Text, Link } from '@dneroswap/uikit'
...
const UsAgreement = () => {
  return (
    <AffiliatesProgramLayout>
      <Container>
        <Text as="h1">DneroSwap Affiliate Program Agreement</Text>
        <Text as="h3">Last modified: Sep 1, 2023</Text>
        <Text as="p">
          This DneroSwap Affiliate Program Agreement (“<strong>Agreement”</strong>) is a legal contract between you (“
          <strong>Affiliate”</strong>) and DneroSwap that applies to your participation in the DneroSwap Affiliate
          Program (“Program”). In this Agreement, “<strong>DneroSwap</strong>,” “<strong>we</strong>” or “
          <strong>us</strong>” means DneroSwap. If you are participating or registering on behalf of a business, then
          ...
          web page), you agree to this Agreement which may be amended from time to time by DneroSwap.
        </Text>
        ...
        <Text as="p">
          ...
          users (“<strong>Referrals”</strong>) to register and trade on DneroSwap, in accordance with the terms of
          this Agreement.
        </Text>
        <Text as="p">
          1.2 A Referral must be a new user and must not have interacted or signed with the DneroSwap platform or used
          any of DneroSwap’s services (including but not limited to V2, V3 swapping services, perpetual trading,
          Non-Fungible Tokens and related services, initial farm offerings and similar offerings) (“DneroSwap
          Services”).
        </Text>
        ...
        <Text as="p">
          (a) <strong>3</strong>% on trading fees paid by your Referrals on DneroSwap V2 and DneroSwap V3, limited
          to swap trades on the DNEROCHAIN, Ethereum chain, Polygon zkEVM, zkSync Era, Arbitrum One, Linea, and
          Base chain only; and
        </Text>
        <Text as="p">
        ...
        <Text as="p">
          <Text as="span">(i) Is in the following Dneroswap Swap token lists</Text>
          <Text as="p">
            DNEROCHAIN:
        ...
        <Text as="p">
          (ii) includes at least 1 major token (i.e., DTOKEN, BTC, BUSD, ETH, MATIC, ARB, DAI, USDT and/or USDC)
        </Text>
        <Text as="p">
        ...
        <Text as="p">3.2 All commissions will be paid out in WDNERO tokens.</Text>
        <Text as="p">
        ...
        <Text as="p">
          ...
          3.3(a) , we will calculate your commissions in WDNERO tokens using the prevailing USD price of WDNERO tokens at
          that time.
        </Text>
        <Text as="p">3.4 In calculating your commissions, we reserve the right to determine the:</Text>
        <Text as="p">
          (a) prevailing USD price of the Trading Fees Denomination and the WDNERO tokens by reference to the spot price
        ...
        <Text as="p">
          7.3 Any statements you make about DneroSwap must reflect your honest opinions, beliefs, or experiences and
        ...
        <Text as="p">You warrant, represent, and undertake to DneroSwap that:</Text>
        ...
        <Text as="p">
          ...
          not that of employer and employee. You will not be treated as an employee of DneroSwap for any purpose.
          ...
          offers or representations on behalf of DneroSwap. You shall have no authority to bind DneroSwap, and
          undertake not to hold yourself out as an employee, agent or authorised representative of DneroSwap.
        </Text>

        <Text as="h3">12. No Joint Publicity</Text>
        <Text as="p">
          You may not claim that any materials are created jointly between you and DneroSwap, or attribute any
          materials created or issued by you (including press releases) to DneroSwap.
        </Text>

        <Text as="h3">13. Term and Termination</Text>
        <Text as="p">
          13.1 DneroSwap reserves the right to terminate this Agreement in its entirety with or without cause,
          ...
          reason, you shall immediately cease use of (and remove from your site) all links to the DneroSwap website
          and all images of DneroSwap and other materials provided under the Program.
        </Text>
        <Text as="p">
          13.2 DneroSwap, in its sole discretion, reserves the right to suspend or terminate your account and refuse
          any and all current or future use of the Program, or any other DneroSwap service, for any reason and at any
          time. Such termination will result in the deactivation or deletion of your Affiliate Account.
        </Text>
        <Text as="p">13.3 DneroSwap reserves the right to refuse service to anyone for any reason at any time.</Text>

        <Text as="h3">14. Indemnification</Text>
        <Text as="p">
          You shall indemnify DneroSwap from and against all claims, losses, liabilities, damages, administrative
        ...
        <Text as="p">
          DneroSwap and any of DneroSwap&apos;s officers, directors, employees, shareholders or agents of any of
        ...
        <Text as="p">
          ...
          make any price predictions over the WDNERO tokens;
        </Text>
        <Text as="p">
        ...
        <Text as="p">
          (e) directing or causing existing users or previous users of DneroSwap Services to create new addresses to
          sign up with your referral link
        </Text>
        <Text as="p">
          (f) Conduct marketing or make any representations of any DneroSwap products and services to users in the
        ...
        <Text as="p">
          DneroSwap may provide you with trademarks and/or graphical images that can be used to promote DneroSwap.
          You may not modify these trademarks and/or images in any way. DneroSwap reserves the right to change the
        ...
        <Text as="p">
          ...
          relationship as an Affiliate which is promoting DneroSwap. For example:
        </Text>
        <Text as="p">
          (a) If you promote DneroSwap through a web page, podcast, blog post, or social media post as an endorsement
          or review of DneroSwap or incentivise others to do so, you must ensure that such post includes a clear
          disclosure that it is an advertisement or was otherwise promoted by DneroSwap; and
        </Text>
        <Text as="p">
        ...
        <Text as="p">
          ...
          Zambia, Zimbabwe (or any additional country or jurisdiction added to this list by DneroSwap from time to
