...
import { Flex, Box, Text, RefreshIcon, WarningIcon, ScanLink } from '@dneroswap/uikit'
import { useTranslation } from '@dneroswap/localization'
import { chains } from 'utils/wagmi'
import { ChainLogo } from 'components/Logo/ChainLogo'
import { getBlockExploreLink, getBlockExploreName } from 'utils'
import { FarmTransactionStatus, NonDneroFarmTransactionStep } from 'state/transactions/actions'
import { ChainLinkSupportChains } from 'state/info/constant'

interface HarvestDetailProps {
  status: FarmTransactionStatus
  step: NonDneroFarmTransactionStep
}
        ...
        <Box>
          {isLoading ? (
            ...
            <Flex>
              ...
              {step.tx && (
                <ScanLink
                  useDneroCoinFallback={ChainLinkSupportChains.includes(step.chainId)}
