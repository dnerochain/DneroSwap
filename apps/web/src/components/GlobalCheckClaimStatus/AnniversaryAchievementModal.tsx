import { AutoRenewIcon, Box, Button, Flex, Modal, Text, ModalV2, useToast } from '@dneroswap/uikit'
...
const AnniversaryAchievementModal: React.FC<AnniversaryModalProps> = ({ excludeLocations }) => {
  ...
  const contract = useAnniversaryAchievementContract({ chainId: ChainId.DNERO })
  ...
  useEffect(() => {
    ...
    if (account && chainId === ChainId.DNERO) {
