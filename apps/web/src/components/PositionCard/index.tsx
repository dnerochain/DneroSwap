...
import { Currency, CurrencyAmount, Pair, Percent } from '@dneroswap/sdk'
import { Text, Card, CardBody, Flex, CardProps, TooltipText, useTooltip, Link, AutoColumn } from '@dneroswap/uikit'
      ...
      {userPoolBalance && userPoolBalance.quotient > BIG_INT_ZERO ? (
        ...
        <LightCard>
          <Text fontSize="14px" style={{ textAlign: 'center' }}>
            <span role="img" aria-label="dnero-icon">
              🥞
            </span>{' '}
            {isStableLP ? (
              <>
