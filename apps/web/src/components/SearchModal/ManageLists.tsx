...
import { TokenList, Version } from '@dneroswap/token-lists'
import {
  acceptListUpdate,
  disableList,
  enableList,
...
} from '@dneroswap/token-lists/react'
import {
  AutoColumn,
  Button,
  CheckmarkIcon,
...
import uriToHttp from '@dneroswap/utils/uriToHttp'
  ...
  const sortedLists = useMemo(() => {
    ...
    return listUrls
      ...
      .sort((u1, u2) => {
        ...
        if (l1 && l2) {
          // Always make DneroSwap list in top.
