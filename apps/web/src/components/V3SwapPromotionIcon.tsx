import { IconButton, Text, TooltipText, useTooltip } from '@dneroswap/uikit'
...
export const v3PromotionFarms = {
  [ChainId.DNERO]: {
    3: true, // BUSD-WDTOKEN LP pid
    10: true, // ETH-DTOKEN LP pid
    11: true, // BTCB-DTOKEN LP pid
    13: true, // USDT-DTOKEN LP pid
  },
}
...
export const V3SwapPromotionIcon: React.FC<{ wrapperStyle?: React.CSSProperties }> = ({ wrapperStyle }) => {
  ...
  } = useTooltip(<Text>{t('Claim $135K WDNERO Airdrop & Exclusive NFT')}</Text>, {
    placement: 'top',
    trigger: 'hover',
      ...
      <ColoredIconButton className="is-shining" variant="text" scale="sm">
        ...
        >
          <Text
            ...
            onClick={() => {
              window.open(
                'https://blog.pancakeswap.finance/articles/participate-in-dneroswap-swap-v3-launch-claim-135-k-wdnero-airdrop-and-receive-an-exclusive-nft-for-early-supporters',
                '_blank',
                'noreferrer noopener',
              )
            }}
