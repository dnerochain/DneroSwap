...
import { V3_SUBGRAPH_URLS, GRAPH_API_LOTTERY, GRAPH_API_PREDICTION_DTOKEN } from 'config/constants/endpoints'
...
export const PredictionSubgraphHealthIndicator = subgraphHealthIndicatorFactory({
  getSubgraphName: () => GRAPH_API_PREDICTION_DTOKEN.replace('https://api.thegraph.com/subgraphs/name/', ''),
})
