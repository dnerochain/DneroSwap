...
import { useTranslation, TranslateFunction } from '@dneroswap/localization'
import { styled } from 'styled-components'
import { Card, Flex, Box, InfoIcon, Text, useTooltip } from '@dneroswap/uikit'
  ...
  ({
    delayed: {
      ...
      description:
        ...
        t(
          'Subgraph is currently experiencing delays due to DNERO issues. Performance may suffer until subgraph is restored.',
        ),
    },
    slow: {
...
export const SubgraphHealthIndicator: React.FC<SubgraphHealthIndicatorProps> = ({
  ...
  const secondRemainingBlockSync = blockDifference * DNERO_BLOCK_TIME
