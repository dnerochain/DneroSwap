import { SUPPORTED_CHAIN_IDS as IFO_SUPPORTED_CHAINS } from '@dneroswap/ifos'
import { ContextApi } from '@dneroswap/localization'
import { SUPPORTED_CHAIN_IDS as POOL_SUPPORTED_CHAINS } from '@dneroswap/pools'
import { SUPPORTED_CHAIN_IDS as POSITION_MANAGERS_SUPPORTED_CHAINS } from '@dneroswap/position-managers'
import {
  ...
  [
    {
      ...
      items: [
        ...
        },
        {
          label: `${t('Limit')} (V2)`,
          href: '/limit-orders',
          supportChainIds: SUPPORT_ONLY_DNERO,
    ...
    },
    {
      ...
      items: [
        ...
        {
          label: t('WDNERO Staking'),
          href: '/wdnero-staking',
          supportChainIds: SUPPORT_WDNERO_STAKING,
