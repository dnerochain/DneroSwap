...
} from '@dneroswap/utils/user'
import { ExpertModal } from '@dneroswap/widgets-internal'
        ...
        {mode === SettingsMode.SWAP_LIQUIDITY && (
          <>
            <Flex pt="3px" flexDirection="column">
              ...
              <Flex justifyContent="space-between" alignItems="center" mb="24px">
                {chainId === ChainId.DNERO && <GasSettings />}
              </Flex>
              <TransactionSettings />
            </Flex>
            <Flex justifyContent="space-between" alignItems="center" mb="24px">
            ...
            <Flex justifyContent="space-between" alignItems="center" mb="24px">
              <Flex alignItems="center">
                ...
                <QuestionHelper
                  text={t('Fun sounds to make a truly immersive dneroswap-flipping trading experience')}
                  placement="top"
                  ml="4px"
                />
              </Flex>
              <DneroswapToggle checked={audioPlay} onChange={() => setAudioMode((s) => !s)} scale="md" />
            </Flex>
    ...
    >
      ...
      >
        <AtomBox>
          ...
          <Flex justifyContent="space-between" alignItems="center" mb="24px">
            <Flex alignItems="center">
              <Text>DneroSwap {t('StableSwap')}</Text>
              <QuestionHelper
                text={
                  <Flex flexDirection="column">
                    <Text mr="5px">
          ...
          <Flex justifyContent="space-between" alignItems="center" mb="24px">
            <Flex alignItems="center">
              <Text>{`DneroSwap ${t('MM Linked Pool')}`}</Text>
              <QuestionHelper
                text={
                  <Flex flexDirection="column">
