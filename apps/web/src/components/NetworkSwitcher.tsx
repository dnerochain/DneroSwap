...
const WrongNetworkSelect = ({ switchNetwork, chainId }) => {
  ...
  const localChainId = useLocalNetworkChain() || ChainId.DNERO
  const [, setSessionChainId] = useSessionChainId()

  const localChainName = chains.find((c) => c.id === localChainId)?.name ?? 'DNERO'
...
const SHORT_SYMBOL = {
  ...
  [ChainId.OPDNERO_TESTNET]: 'tOpDNERO',
  [ChainId.BASE]: 'Base',
