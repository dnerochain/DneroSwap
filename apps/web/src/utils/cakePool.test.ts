...
import { UNLOCK_FREE_DURATION, BOOST_WEIGHT, DURATION_FACTOR, MAX_LOCK_DURATION } from '@dneroswap/pools'
import dayjs from 'dayjs'
import { vi, describe, it } from 'vitest'
import { VaultPosition, getVaultPosition } from './wdneroPool'
import { getWDneroVaultV2Contract } from './contractHelpers'

describe.concurrent('wdneroPool', () => {
  it.each([
    ...
    const wdneroVault = getWDneroVaultV2Contract()
    const got = await wdneroVault.read[method]()
