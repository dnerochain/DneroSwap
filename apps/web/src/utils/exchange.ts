import { Currency, CurrencyAmount, Fraction, Percent, Trade, TradeType } from '@dneroswap/sdk'
import { dneroswapRouter02ABI } from 'config/abi/IDneroswapRouter02'
import {
...
export function useRouterContract() {
  ...
  return useContract(V2_ROUTER_ADDRESS[chainId], dneroswapRouter02ABI)
}
