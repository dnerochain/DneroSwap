...
export const v3Clients = {
  ...
  [ChainId.DNERO]: new GraphQLClient(V3_SUBGRAPH_URLS[ChainId.DNERO]),
  [ChainId.DNERO_TESTNET]: new GraphQLClient(V3_SUBGRAPH_URLS[ChainId.DNERO_TESTNET]),
  ...
  [ChainId.OPDNERO]: new GraphQLClient(V3_SUBGRAPH_URLS[ChainId.OPDNERO]),
}

export const v3InfoClients = { ...v3Clients, [ChainId.DNERO]: new GraphQLClient(V3_DNERO_INFO_CLIENT) }

export const infoClientETH = new GraphQLClient(INFO_CLIENT_ETH)

export const v2Clients = {
  [ChainId.ETHEREUM]: infoClientETH,
  [ChainId.DNERO]: infoClient,
  ...
  [ChainId.OPDNERO]: new GraphQLClient(INFO_CLIENT_WITH_CHAIN[ChainId.OPDNERO]),
}
