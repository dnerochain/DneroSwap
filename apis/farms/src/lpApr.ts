...
import { AprMap } from '@dneroswap/farms'
...
const BLOCKS_CLIENT_WITH_CHAIN = {
  [ChainId.DNERO]: 'https://api.thegraph.com/subgraphs/name/pancakeswap/blocks',
...
const getBlockAtTimestamp = async (timestamp: number, chainId = ChainId.DNERO) => {
  try {
