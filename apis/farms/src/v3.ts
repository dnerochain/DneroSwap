...
import { FarmV3SupportedChainId, masterChefV3Addresses } from '@dneroswap/farms'
import { ERC20Token } from '@dneroswap/sdk'
import { CurrencyAmount } from '@dneroswap/swap-sdk-core'
import { PositionMath } from '@dneroswap/v3-sdk'
...
export const V3_SUBGRAPH_CLIENTS = V3_SUBGRAPH_CLIENTS_CHAIN_IDS.reduce((acc, chainId) => {
  ...
  return acc
}, {} as Record<Exclude<FarmV3SupportedChainId, ChainId.POLYGON_ZKEVM_TESTNET | ChainId.OPDNERO_TESTNET>, GraphQLClient>)
