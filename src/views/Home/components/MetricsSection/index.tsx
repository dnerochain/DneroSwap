  ...
  return (
    <Flex justifyContent="center" alignItems="center" flexDirection="column">
      ...
      <Text textAlign="center" color="textSubtle">
        {t('DxChange is the decentralized exchange of LunaChow (LUCHOW) token.')}
      </Text>
      <Flex flexWrap="wrap">
        <Text display="inline" textAlign="center" color="textSubtle" mb="20px">
          {t('DxChange provide a platform where users can provide liquidity and swap for different tokens on Binance Smart Chain.')}
          {/* {entrusting}
