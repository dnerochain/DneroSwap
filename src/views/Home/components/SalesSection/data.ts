...
export const earnSectionData: SalesSectionProps = {
  ...
  bodyText: 'DxChange makes it easy to make your crypto work for you.',
  reverse: true,
  primaryButton: {
    to: '/farms',
    text: 'Explore',
...
export const cakeSectionData: SalesSectionProps = {
  ...
  bodyText:
    'LUCHOW token is at the heart of the DxChange ecosystem. Buy it, win it, farm it, spend it, stake it... heck, you can even vote with it!',
  reverse: false,
  primaryButton: {
