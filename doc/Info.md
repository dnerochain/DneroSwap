...
A brief overview how Info part of DneroSwap website works.
...
`prices` - gets DTOKEN prices (current, 24h, 48 and 7d ago) used in calculations (see [src/hooks/useDTokenPrices.ts](../src/hooks/useDTokenPrices.ts))
